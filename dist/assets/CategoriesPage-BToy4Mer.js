const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/showAddCategoryModal-ogdVWoS5.js","assets/main-CwyRbrt1.js","assets/main-Bjqwg0h6.css"])))=>i.map(i=>d[i]);
import{h as E,e as B,_ as j,i as U}from"./main-CwyRbrt1.js";import{mountPeriodIndicator as _}from"./PeriodIndicator-DVPQSjAd.js";import{a as W,r as V}from"./UIService-gNanDB6v.js";typeof window<"u"&&window.eventBus&&typeof window.eventBus.on=="function"&&window.eventBus.on("categories:updated",()=>{if((window.location.hash||"").split("?")[0]==="#/categories")try{T()}catch(i){console.warn("Falha ao renderizar categorias após atualização",i)}});async function K(s){const i=document.createElement("div");if(i.className="categories-page",!window.showAddCategoryModal)try{const{default:o}=await j(async()=>{const{default:x}=await import("./showAddCategoryModal-ogdVWoS5.js");return{default:x}},__vite__mapDeps([0,1,2]));window.showAddCategoryModal=o,console.log("✅ showAddCategoryModal carregado dinamicamente")}catch(o){console.error("❌ Falha ao carregar showAddCategoryModal:",o)}const f=document.createElement("div");f.className="tab-header mb-6",f.innerHTML=`

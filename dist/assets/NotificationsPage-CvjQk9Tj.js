const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/userSettingsRepo-CnusBZZm.js","assets/main-IfYbxsCz.js","assets/main-DilUQiCL.css","assets/NotificationService-cLgfX4Fr.js"])))=>i.map(i=>d[i]);
import{h as S,A as V,B as q,C as G,m as Y,D as J,E as W,_ as C,e as b,F as ft}from"./main-IfYbxsCz.js";import{mountPeriodIndicator as ut}from"./PeriodIndicator-DW2_keOF.js";import{getNotificationModal as pt}from"./NotificationModal-Cd6p2lEC.js";function yt(t,e){const o=new Date,n={all:null,today:new Date(o.getFullYear(),o.getMonth(),o.getDate()),"7d":new Date(o.getTime()-10080*60*1e3),"30d":new Date(o.getTime()-720*60*60*1e3)}[e?.period||"all"];let r=null,d=null;try{const i=typeof S=="function"?S():null;!n&&i&&i.year&&i.month&&(r=new Date(i.year,i.month-1,1,0,0,0,0),d=new Date(i.year,i.month,0,23,59,59,999))}catch{}return(t||[]).filter(i=>{if(e?.unreadOnly&&i.read||!(!e?.types||e.types.includes(i.type)))return!1;const p=i.createdAt?.toDate?i.createdAt.toDate():i.createdAt?.seconds?new Date(i.createdAt.seconds*1e3):new Date(i.createdAt);return n?p>=n:r&&d?p>=r&&p<=d:!0})}function mt(t){const e={};return(t||[]).forEach(o=>{const r=(o.createdAt?.toDate?o.createdAt.toDate():new Date(o.createdAt)).toDateString();e[r]||(e[r]=[]),e[r].push(o)}),Object.keys(e).sort((o,n)=>new Date(n)-new Date(o)).map(o=>({label:o,items:e[o]}))}function K(t){const e=t.type==="deleted_transaction"?"bg-red-100 dark:bg-red-900":t.type==="updated_transaction"?"bg-yellow-100 dark:bg-yellow-900":t.type&&t.type.startsWith("category_")?"bg-purple-100 dark:bg-purple-900":t.type==="test_notification"?"bg-emerald-100 dark:bg-emerald-900":"bg-blue-100 dark:bg-blue-900",o=t.type==="deleted_transaction"?"🗑️":t.type==="updated_transaction"?"✏️":t.type&&t.type.startsWith("category_")?"📂":t.type==="test_notification"?"📣":"💰",n=t.type==="deleted_transaction"&&"Transação Excluída"||t.type==="updated_transaction"&&"Transação Atualizada"||t.type==="new_transaction"&&"Nova Transação"||t.type==="category_added"&&"Categoria Criada"||t.type==="category_updated"&&"Categoria Atualizada"||t.type==="category_deleted"&&"Categoria Excluída"||t.type==="test_notification"&&"Notificação de Teste"||"Notificação",r=t.createdAt?.toDate?t.createdAt.toDate().toLocaleString("pt-BR"):"Data não disponível",d=m=>{if(typeof m!="number")return m??"-";try{return m.toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}catch{return String(m)}},i=t.changes||{},p=Object.keys(i).length>0?`

                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                                            ...
                                            <div class="font-bold text-sm text-gray-800 dark:text-gray-200">v4.39.0</div>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-gray-200 dark:border-gray-600">
                                ...
                                <div class="space-y-2 text-xs">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium text-gray-800 dark:text-gray-200">financeiro-static-v4.39.0</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">Cache Dinâmico:</span>
                                        <span class="font-medium text-gray-800 dark:text-gray-200">financeiro-dynamic-v4.39.0</span>
                                    </div>
                                    <div class="flex justify-between">

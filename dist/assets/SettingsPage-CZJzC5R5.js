                                ...
                                <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span class="text-gray-900 dark:text-gray-100">v4.37.0</span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="font-medium text-gray-700 dark:text-gray-300">Cache Estático:</span>
                                            <span class="text-gray-900 dark:text-gray-100">financeiro-static-v4.37.0</span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="font-medium text-gray-700 dark:text-gray-300">Cache Dinâmico:</span>
                                            <span class="text-gray-900 dark:text-gray-100">financeiro-dynamic-v4.37.0</span>
                                        </div>
                                        <div class="flex justify-between">

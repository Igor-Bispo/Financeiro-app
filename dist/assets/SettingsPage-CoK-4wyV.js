...
import{_ as v,e as c}from"./main-CcZKm8fI.js";import{loadBudgetInvitations as u,loadSentBudgetInvitations as y,fetchUsersInfo as h,fetchUserInfo as f}from"./settings.service-BW6kSVui.js";function m(s){s?(document.body.classList.remove("no-animations"),localStorage.setItem("animationsEnabled","1")):(document.body.classList.add("no-animations"),localStorage.setItem("animationsEnabled","0"))}document.addEventListener("DOMContentLoaded",()=>{const s=localStorage.getItem("animationsEnabled"),e=s===null?!0:s==="1";m(e);const r=document.getElementById("animations-toggle");r&&(r.checked=e,r.addEventListener("change",a=>{m(a.target.checked)}))});function x(s,e,r){return`
    ...
    <div class="space-y-3">
        ...
        `).join("")}
    </div>`}function A(s){const{currentUser:e,currentBudget:r,budgets:a,usersWithAccess:d,ownerDisplay:t,pendingInvitations:o,sentInvitations:l,appVersion:i}=s;return`
                            ...
                            <div class="grid grid-cols-2 gap-1">
                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-md p-2 shadow-sm border border-gray-200 dark:border-gray-600">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-1">
                                            <span class="text-sm">🔧</span>
                                            <span class="text-xs font-medium text-gray-800 dark:text-gray-200">${r?.createdAt?new Date(r.createdAt.seconds*1e3).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}):"N/A"}</span>
                                        </div>
                                        <span class="text-xs text-green-600 dark:text-green-400">${i}</span>
                                    </div>
                                </div>
                            </div>
                        </div>

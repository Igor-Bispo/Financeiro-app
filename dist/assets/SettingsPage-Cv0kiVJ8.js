const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-B8ndfATB.js","assets/main-ByTmGh6x.css"])))=>i.map(i=>d[i]);
import{_ as u,e as c}from"./main-B8ndfATB.js";import{loadBudgetInvitations as v,loadSentBudgetInvitations as y,fetchUsersInfo as f,fetchUserInfo as h}from"./settings.service-DaQowaPa.js";function b(r){r?(document.body.classList.remove("no-animations"),localStorage.setItem("animationsEnabled","1")):(document.body.classList.add("no-animations"),localStorage.setItem("animationsEnabled","0"))}document.addEventListener("DOMContentLoaded",()=>{const r=localStorage.getItem("animationsEnabled"),e=r===null?!0:r==="1";b(e);const a=document.getElementById("animations-toggle");a&&(a.checked=e,a.addEventListener("change",s=>{b(s.target.checked)}))});function x(r,e,a){return`
    ...
    <div class="space-y-3">
        ...
        `).join("")}
    </div>`}function $(r){return!r||r.length===0?`
        <div class="text-center py-8">
            <div class="text-4xl mb-3">📬</div>
            <div class="text-gray-500 dark:text-gray-400">Nenhum convite pendente</div>
    ...
    <div class="space-y-3">
        ...
        `).join("")}
    </div>`}function E(r){const{currentUser:e,currentBudget:a,budgets:s,usersWithAccess:d,ownerDisplay:t,pendingInvitations:o,sentInvitations:l,appVersion:i}=r;return`
                        ...
                        <div class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 rounded-2xl shadow-lg border border-blue-200 dark:border-gray-600 p-4 mb-6">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-gray-200 dark:border-gray-600 mb-4">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-xs">
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">Versão:</span>
                                        <span class="font-medium text-gray-800 dark:text-gray-200">${i}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">SW:</span>
                                        <span class="font-medium text-gray-800 dark:text-gray-200">v4.38.0</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">Desenvolvedor:</span>
                                        <span class="font-medium text-gray-800 dark:text-gray-200">Igor Bispo</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">Tecnologias:</span>
                                        <span class="font-medium text-gray-800 dark:text-gray-200">Firebase, JS, PWA</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">Atualização:</span>
                                        <span class="font-medium text-gray-800 dark:text-gray-200">Set 2025</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">Status:</span>
                                        <span class="font-bold text-green-600 dark:text-green-400">Online</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-gray-200 dark:border-gray-600 mb-4">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <button id="check-updates-btn" class="u-btn u-btn--primary text-xs flex items-center justify-center gap-1 p-2">
                                        <span>☁️⬇️</span>
                                        <span>Atualizações</span>
                                    </button>
                                    <button id="help-support-btn" class="u-btn u-btn--secondary text-xs flex items-center justify-center gap-1 p-2">
                                        <span>❓</span>
                                        <span>Suporte</span>
                                    </button>
                                    <button id="whats-new-btn" class="u-btn u-btn--secondary text-xs flex items-center justify-center gap-1 p-2">
                                        <span>📄</span>
                                        <span>O que mudou</span>
                                    </button>
                                    <button id="copy-info-btn" class="u-btn u-btn--ghost text-xs flex items-center justify-center gap-1 p-2">
                                        <span>📋</span>
                                        <span>Copiar Info</span>
                                    </button>
                                    <button id="clear-cache-btn" class="u-btn u-btn--danger text-xs flex items-center justify-center gap-1 p-2">
                                        <span>🗑️</span>
                                        <span>Limpar Cache</span>
                                    </button>
                                    <button id="install-app-btn" class="u-btn u-btn--primary text-xs flex items-center justify-center gap-1 p-2">
                                        <span>⬇️</span>
                                        <span>Instalar</span>
                                    </button>
                                </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-gray-200 dark:border-gray-600">
                                ...
                                <div class="space-y-2 text-xs">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium text-gray-800 dark:text-gray-200">financeiro-static-v4.38.0</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">Cache Dinâmico:</span>
                                        <span class="font-medium text-gray-800 dark:text-gray-200">financeiro-dynamic-v4.38.0</span>
                                    </div>
                                    <div class="flex justify-between">

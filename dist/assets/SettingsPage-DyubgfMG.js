          ...
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center gap-3">
              <div class="flex items-center gap-2">
                ...
                <div>
                  <h2 class="text-gray-800 dark:text-white font-semibold text-base">Configurações</h2>

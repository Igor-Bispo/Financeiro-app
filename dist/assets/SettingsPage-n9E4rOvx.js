          ...
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center gap-3">
              <div class="flex items-center gap-2">
                ...
                <div>
                  <h1 class="text-2xl font-semibold text-gray-900 leading-tight">⚙️ Configurações</h1>

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-ttxvzXhd.js","assets/PeriodIndicator-se6r7eHK.js","assets/TransactionsPage-CkTvErlY.js","assets/UIService-AcYpZD3K.js","assets/perf-tobPnqr4.js","assets/CategoriesPage-DY3El1NU.js","assets/NotificationsPage-DeR-DWLk.js","assets/NotificationModal-CoAXtAUo.js","assets/NotificationService-CM40f6NQ.js","assets/VoiceService-F1rMbtYP.js","assets/VoiceSystem-CEBe8orV.js","assets/AuthService-DU0x5yUO.js"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();const sw="modulepreload",aw=function(n){return"/"+n},wu={},C=function(e,t,o){let r=Promise.resolve();if(t&&t.length>0){let u=function(d){return Promise.all(d.map(f=>Promise.resolve(f).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),c=s?.nonce||s?.getAttribute("nonce");r=u(t.map(d=>{if(d=aw(d),d in wu)return;wu[d]=!0;const f=d.endsWith(".css"),p=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${p}`))return;const m=document.createElement("link");if(m.rel=f?"stylesheet":sw,f||(m.as="script"),m.crossOrigin="",m.href=d,c&&m.setAttribute("nonce",c),document.head.appendChild(m),f)return new Promise((S,R)=>{m.addEventListener("load",S),m.addEventListener("error",()=>R(new Error(`Unable to preload CSS for ${d}`)))})}))}function i(s){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=s,window.dispatchEvent(c),!c.defaultPrevented)throw s}return r.then(s=>{for(const c of s||[])c.status==="rejected"&&i(c.reason);return e().catch(i)})},cw=()=>{};var yu={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vw=1e3,Bw=2,xw=14400*1e3,Lw=.5;function Eu(n,e=Vw,t=Bw){const o=e*Math.pow(t,n),r=Math.round(Lw*o*(Math.random()-.5)*2);return Math.min(xw,o+r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function po(n){if(n.code!==N.FAILED_PRECONDITION||n.message!==iE)throw n;L("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tb{constructor(){this.changes=new Sn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,xe.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const o=this.changes.get(t);return o!==void 0?k.resolve(o):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve="WebChannelConnection";class Yb extends Kb{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,o,r,i){const s=ka();return new Promise((c,u)=>{const d=new af;d.setWithCredentials(!0),d.listenOnce(cf.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case ci.NO_ERROR:const p=d.getResponseJson();L(Ve,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(p)),c(p);break;case ci.TIMEOUT:L(Ve,`RPC '${e}' ${s} timed out`),u(new x(N.DEADLINE_EXCEEDED,"Request time out"));break;case ci.HTTP_ERROR:const m=d.getStatus();if(L(Ve,`RPC '${e}' ${s} failed with status:`,m,"response text:",d.getResponseText()),m>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const R=S?.error;if(R&&R.status&&R.message){const M=function(U){const G=U.toLowerCase().replace(/_/g,"-");return Object.values(N).indexOf(G)>=0?G:N.UNKNOWN}(R.status);u(new x(M,R.message))}else u(new x(N.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new x(N.UNAVAILABLE,"Connection failed."));break;default:$(9055,{l_:e,streamId:s,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{L(Ve,`RPC '${e}' ${s} completed.`)}});const f=JSON.stringify(r);L(Ve,`RPC '${e}' ${s} sending request:`,r),d.send(t,"POST",f,o,15)})}T_(e,t,o){const r=ka(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],s=df(),c=uf(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,t,o),u.encodeInitMessageHeaders=!0;const f=i.join("");L(Ve,`Creating RPC '${e}' stream ${r}: ${f}`,u);const p=s.createWebChannel(f,u);this.I_(p);let m=!1,S=!1;const R=new Qb({Yo:P=>{S?L(Ve,`Not sending because RPC '${e}' stream ${r} is closed:`,P):(m||(L(Ve,`Opening RPC '${e}' stream ${r} transport.`),p.open(),m=!0),L(Ve,`RPC '${e}' stream ${r} sending:`,P),p.send(P))},Zo:()=>p.close()}),M=(P,U,G)=>{P.listen(U,W=>{try{G(W)}catch(ue){setTimeout(()=>{throw ue},0)}})};return M(p,Go.EventType.OPEN,()=>{S||(L(Ve,`RPC '${e}' stream ${r} transport opened.`),R.o_())}),M(p,Go.EventType.CLOSE,()=>{S||(S=!0,L(Ve,`RPC '${e}' stream ${r} transport closed`),R.a_(),this.E_(p))}),M(p,Go.EventType.ERROR,P=>{S||(S=!0,_n(Ve,`RPC '${e}' stream ${r} transport errored. Name:`,P.name,"Message:",P.message),R.a_(new x(N.UNAVAILABLE,"The operation could not be completed")))}),M(p,Go.EventType.MESSAGE,P=>{if(!S){const U=P.data[0];te(!!U,16349);const G=U,W=G?.error||G[0]?.error;if(W){L(Ve,`RPC '${e}' stream ${r} received error:`,W);const ue=W.status;let Ne=function(w){const _=we[w];if(_!==void 0)return Wf(_)}(ue),ie=W.message;Ne===void 0&&(Ne=N.INTERNAL,ie="Unknown error status: "+ue+" with message "+W.message),S=!0,R.a_(new x(Ne,ie)),p.close()}else L(Ve,`RPC '${e}' stream ${r} received:`,U),R.u_(U)}}),M(c,lf.STAT_EVENT,P=>{P.stat===_a.PROXY?L(Ve,`RPC '${e}' stream ${r} detected buffering proxy`):P.stat===_a.NOPROXY&&L(Ve,`RPC '${e}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{R.__()},0),R}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(t=>t===e)}}function ta(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cI=/^[cdef][\w-]{21}$/,xa="";function lI(){try{const n=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(n),n[0]=112+n[0]%16;const t=uI(n);return cI.test(t)?t:xa}catch{return xa}}function uI(n){return aI(n).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oi="analytics",xI="firebase_id",LI="origin",UI=60*1e3,FI="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",jc="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

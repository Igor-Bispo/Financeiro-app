const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DRUDXAB3.js","assets/PeriodIndicator-BvDvPqz3.js","assets/TransactionsPage-DZDU9IF-.js","assets/UIService-M1k5vVFb.js","assets/perf-tobPnqr4.js","assets/CategoriesPage-BVkh3BHG.js","assets/NotificationsPage-D0ybCsma.js","assets/NotificationModal-B_wGkvjR.js","assets/NotificationService-D3m5isBu.js","assets/VoiceService-F1rMbtYP.js","assets/VoiceSystem-CEBe8orV.js","assets/AuthService-C6MtzL5_.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xw=1e3,Bw=2,Lw=14400*1e3,Uw=.5;function Eu(n,e=xw,t=Bw){const o=e*Math.pow(t,n),r=Math.round(Uw*o*(Math.random()-.5)*2);return Math.min(Lw,o+r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ou(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Lh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Vh(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Fh(e))return"Blackberry";if($h(e))return"Webos";if(xh(e))return"Safari";if((e.includes("chrome/")||Bh(e))&&!e.includes("edge/"))return"Chrome";if(Uh(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,o=n.match(t);if(o?.length===2)return o[1]}return"Other"}function Vh(n=Ue()){return/firefox\//i.test(n)}function xh(n=Ue()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Bh(n=Ue()){return/crios\//i.test(n)}function Lh(n=Ue()){return/iemobile/i.test(n)}function Uh(n=Ue()){return/android/i.test(n)}function Fh(n=Ue()){return/blackberry/i.test(n)}function $h(n=Ue()){return/webos/i.test(n)}function Xa(n=Ue()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function g_(n=Ue()){return Xa(n)&&!!window.navigator?.standalone}function p_(){return Aw()&&document.documentMode===10}function Gh(n=Ue()){return Xa(n)||Uh(n)||$h(n)||Fh(n)||/windows phone/i.test(n)||Lh(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt extends fr{constructor(){super("facebook.com")}static credential(e){return wn._fromParams({providerId:xt.PROVIDER_ID,signInMethod:xt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return xt.credentialFromTaggedObject(e)}static credentialFromError(e){return xt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return xt.credential(e.oauthAccessToken)}catch{return null}}}xt.FACEBOOK_SIGN_IN_METHOD="facebook.com";xt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O_(n,e){return he(n).setPersistence(e)}function V_(n,e,t,o){return he(n).onIdTokenChanged(e,t,o)}function x_(n,e,t){return he(n).beforeAuthStateChanged(e,t)}function B_(n,e,t,o){return he(n).onAuthStateChanged(e,t,o)}const vi="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ff{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class gf{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(xe.UNAUTHENTICATED))}shutdown(){}}class Kv{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class Qv{constructor(e){this.t=e,this.currentUser=xe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){te(this.o===void 0,42304);let o=this.i;const r=u=>this.i!==o?(o=this.i,t(u)):Promise.resolve();let i=new It;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new It,e.enqueueRetryable(()=>r(this.currentUser))};const s=()=>{const u=i;e.enqueueRetryable(async()=>{await u.promise,await r(this.currentUser)})},c=u=>{L("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),s())};this.t.onInit(u=>c(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?c(u):(L("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new It)}},0),s()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(o=>this.i!==e?(L("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):o?(te(typeof o.accessToken=="string",31837,{l:o}),new ff(o.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return te(e===null||typeof e=="string",2055,{h:e}),new xe(e)}}class Yv{constructor(e,t,o){this.P=e,this.T=t,this.I=o,this.type="FirstParty",this.user=xe.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const e=this.R();return e&&this.A.set("Authorization",e),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class Jv{constructor(e,t,o){this.P=e,this.T=t,this.I=o}getToken(){return Promise.resolve(new Yv(this.P,this.T,this.I))}start(e,t){e.enqueueRetryable(()=>t(xe.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Yu{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Xv{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Ze(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){te(this.o===void 0,3512);const o=i=>{i.error!=null&&L("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const s=i.token!==this.m;return this.m=i.token,L("FirebaseAppCheckTokenProvider",`Received ${s?"new":"existing"} token.`),s?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>o(i))};const r=i=>{L("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(i=>r(i)),setTimeout(()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?r(i):L("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new Yu(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(te(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new Yu(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _e(n,e){const t={typeString:n};return e&&(t.value=e),t}function pr(n,e){if(!wf(n))throw new B(P.INVALID_ARGUMENT,"JSON must be an object");let t;for(const o in e)if(e[o]){const r=e[o].typeString,i="value"in e[o]?{value:e[o].value}:void 0;if(!(o in n)){t=`JSON missing required field: '${o}'`;break}const s=n[o];if(r&&typeof s!==r){t=`JSON field '${o}' must be a ${r}.`;break}if(i!==void 0&&s!==i.value){t=`Expected '${o}' field to equal '${i.value}'`;break}}if(t)throw new B(P.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function po(n){if(n.code!==P.FAILED_PRECONDITION||n.message!==sE)throw n;L("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PE=new le(F.comparator);function Rt(){return PE}const Bf=new le(F.comparator);function zo(...n){let e=Bf;for(const t of n)e=e.insert(t.key,t);return e}function Lf(n){let e=Bf;return n.forEach((t,o)=>e=e.insert(t,o.overlayedDocument)),e}function hn(){return Jo()}function Uf(){return Jo()}function Jo(){return new Sn(n=>n.toString(),(n,e)=>n.isEqual(e))}const kE=new le(F.comparator),ME=new Ee(F.comparator);function Y(...n){let e=ME;for(const t of n)e=e.add(t);return e}const OE=new Ee(Q);function VE(){return OE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lc(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:bi(e)?"-0":e}}function Ff(n){return{integerValue:""+n}}function xE(n,e){return lE(e)?Ff(e):lc(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xb{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=function(){return Dw()?8:cE(Ue())>0?6:4}()}initialize(e,t){this.ps=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,o,r){const i={result:null};return this.ys(e,t).next(s=>{i.result=s}).next(()=>{if(!i.result)return this.ws(e,t,r,o).next(s=>{i.result=s})}).next(()=>{if(i.result)return;const s=new Vb;return this.Ss(e,t,s).next(c=>{if(i.result=c,this.Vs)return this.bs(e,t,s,c.size)})}).next(()=>i.result)}bs(e,t,o,r){return o.documentReadCount<this.fs?(xn()<=K.DEBUG&&L("QueryEngine","SDK will not create cache indexes for query:",Bn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),M.resolve()):(xn()<=K.DEBUG&&L("QueryEngine","Query:",Bn(t),"scans",o.documentReadCount,"local documents and returns",r,"documents as results."),o.documentReadCount>this.gs*r?(xn()<=K.DEBUG&&L("QueryEngine","The SDK decides to create cache indexes for query:",Bn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,dt(t))):M.resolve())}ys(e,t){if(fd(t))return M.resolve(null);let o=dt(t);return this.indexManager.getIndexType(e,o).next(r=>r===0?null:(t.limit!==null&&r===1&&(t=Aa(t,null,"F"),o=dt(t)),this.indexManager.getDocumentsMatchingTarget(e,o).next(i=>{const s=Y(...i);return this.ps.getDocuments(e,s).next(c=>this.indexManager.getMinOffset(e,o).next(u=>{const d=this.Ds(t,c);return this.Cs(t,d,s,u.readTime)?this.ys(e,Aa(t,null,"F")):this.vs(e,d,t,u)}))})))}ws(e,t,o,r){return fd(t)||r.isEqual(q.min())?M.resolve(null):this.ps.getDocuments(e,o).next(i=>{const s=this.Ds(t,i);return this.Cs(t,s,o,r)?M.resolve(null):(xn()<=K.DEBUG&&L("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),Bn(t)),this.vs(e,s,t,oE(r,ir)).next(c=>c))})}Ds(e,t){let o=new Ee(xf(e));return t.forEach((r,i)=>{Ji(e,i)&&(o=o.add(i))}),o}Cs(e,t,o,r){if(e.limit===null)return!1;if(o.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Ss(e,t,o){return xn()<=K.DEBUG&&L("QueryEngine","Using full collection scan to execute query:",Bn(t)),this.ps.getDocumentsMatchingQuery(e,t,Ht.min(),o)}vs(e,t,o,r){return this.ps.getDocumentsMatchingQuery(e,o,r).next(i=>(t.forEach(s=>{i=i.insert(s.key,s)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cd="ConnectivityMonitor";class Rd{constructor(){this.No=()=>this.Bo(),this.Lo=()=>this.ko(),this.qo=[],this.Qo()}Oo(e){this.qo.push(e)}shutdown(){window.removeEventListener("online",this.No),window.removeEventListener("offline",this.Lo)}Qo(){window.addEventListener("online",this.No),window.addEventListener("offline",this.Lo)}Bo(){L(Cd,"Network connectivity changed: AVAILABLE");for(const e of this.qo)e(0)}ko(){L(Cd,"Network connectivity changed: UNAVAILABLE");for(const e of this.qo)e(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve="WebChannelConnection";class Jb extends Qb{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,o,r,i){const s=ka();return new Promise((c,u)=>{const d=new af;d.setWithCredentials(!0),d.listenOnce(cf.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case ci.NO_ERROR:const g=d.getResponseJson();L(Ve,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(g)),c(g);break;case ci.TIMEOUT:L(Ve,`RPC '${e}' ${s} timed out`),u(new B(P.DEADLINE_EXCEEDED,"Request time out"));break;case ci.HTTP_ERROR:const m=d.getStatus();if(L(Ve,`RPC '${e}' ${s} failed with status:`,m,"response text:",d.getResponseText()),m>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const C=S?.error;if(C&&C.status&&C.message){const k=function(U){const G=U.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(G)>=0?G:P.UNKNOWN}(C.status);u(new B(k,C.message))}else u(new B(P.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new B(P.UNAVAILABLE,"Connection failed."));break;default:$(9055,{l_:e,streamId:s,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{L(Ve,`RPC '${e}' ${s} completed.`)}});const f=JSON.stringify(r);L(Ve,`RPC '${e}' ${s} sending request:`,r),d.send(t,"POST",f,o,15)})}T_(e,t,o){const r=ka(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],s=df(),c=uf(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,t,o),u.encodeInitMessageHeaders=!0;const f=i.join("");L(Ve,`Creating RPC '${e}' stream ${r}: ${f}`,u);const g=s.createWebChannel(f,u);this.I_(g);let m=!1,S=!1;const C=new Yb({Yo:N=>{S?L(Ve,`Not sending because RPC '${e}' stream ${r} is closed:`,N):(m||(L(Ve,`Opening RPC '${e}' stream ${r} transport.`),g.open(),m=!0),L(Ve,`RPC '${e}' stream ${r} sending:`,N),g.send(N))},Zo:()=>g.close()}),k=(N,U,G)=>{N.listen(U,W=>{try{G(W)}catch(ue){setTimeout(()=>{throw ue},0)}})};return k(g,Go.EventType.OPEN,()=>{S||(L(Ve,`RPC '${e}' stream ${r} transport opened.`),C.o_())}),k(g,Go.EventType.CLOSE,()=>{S||(S=!0,L(Ve,`RPC '${e}' stream ${r} transport closed`),C.a_(),this.E_(g))}),k(g,Go.EventType.ERROR,N=>{S||(S=!0,_n(Ve,`RPC '${e}' stream ${r} transport errored. Name:`,N.name,"Message:",N.message),C.a_(new B(P.UNAVAILABLE,"The operation could not be completed")))}),k(g,Go.EventType.MESSAGE,N=>{if(!S){const U=N.data[0];te(!!U,16349);const G=U,W=G?.error||G[0]?.error;if(W){L(Ve,`RPC '${e}' stream ${r} received error:`,W);const ue=W.status;let Ne=function(w){const _=we[w];if(_!==void 0)return Wf(_)}(ue),ie=W.message;Ne===void 0&&(Ne=P.INTERNAL,ie="Unknown error status: "+ue+" with message "+W.message),S=!0,C.a_(new B(Ne,ie)),g.close()}else L(Ve,`RPC '${e}' stream ${r} received:`,U),C.u_(U)}}),k(c,lf.STAT_EVENT,N=>{N.stat===_a.PROXY?L(Ve,`RPC '${e}' stream ${r} detected buffering proxy`):N.stat===_a.NOPROXY&&L(Ve,`RPC '${e}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{C.__()},0),C}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(t=>t===e)}}function ta(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eT{}class tT extends eT{constructor(e,t,o,r){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=o,this.serializer=r,this.ia=!1}sa(){if(this.ia)throw new B(P.FAILED_PRECONDITION,"The client has already been terminated.")}Go(e,t,o,r){return this.sa(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,s])=>this.connection.Go(e,Ca(t,o),r,i,s)).catch(i=>{throw i.name==="FirebaseError"?(i.code===P.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new B(P.UNKNOWN,i.toString())})}Ho(e,t,o,r,i){return this.sa(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,c])=>this.connection.Ho(e,Ca(t,o),r,s,c,i)).catch(s=>{throw s.name==="FirebaseError"?(s.code===P.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),s):new B(P.UNKNOWN,s.toString())})}terminate(){this.ia=!0,this.connection.terminate()}}class nT{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.oa=0,this._a=null,this.aa=!0}ua(){this.oa===0&&(this.ca("Unknown"),this._a=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this._a=null,this.la("Backend didn't respond within 10 seconds."),this.ca("Offline"),Promise.resolve())))}ha(e){this.state==="Online"?this.ca("Unknown"):(this.oa++,this.oa>=1&&(this.Pa(),this.la(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.ca("Offline")))}set(e){this.Pa(),this.oa=0,e==="Online"&&(this.aa=!1),this.ca(e)}ca(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}la(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sg="firestore.googleapis.com",Ud=!0;class Fd{constructor(e){if(e.host===void 0){if(e.ssl!==void 0)throw new B(P.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=Sg,this.ssl=Ud}else this.host=e.host,this.ssl=e.ssl??Ud;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=og;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<_b)throw new B(P.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}mf("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=Ig(e.experimentalLongPollingOptions??{}),function(o){if(o.timeoutSeconds!==void 0){if(isNaN(o.timeoutSeconds))throw new B(P.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (must not be NaN)`);if(o.timeoutSeconds<5)throw new B(P.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (minimum allowed value is 5)`);if(o.timeoutSeconds>30)throw new B(P.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(o,r){return o.timeoutSeconds===r.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class is{constructor(e,t,o,r){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=o,this._app=r,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Fd({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new B(P.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new B(P.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Fd(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=function(o){if(!o)return new gf;switch(o.type){case"firstParty":return new Jv(o.sessionIndex||"0",o.iamToken||null,o.authTokenFactory||null);case"provider":return o.client;default:throw new B(P.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(t){const o=Ld.get(t);o&&(L("ComponentProvider","Removing Datastore"),Ld.delete(t),o.terminate())}(this),Promise.resolve()}}function Ag(n,e,t,o={}){n=Le(n,is);const r=uo(e),i=n._getSettings(),s={...i,emulatorOptions:n._getEmulatorOptions()},c=`${e}:${t}`;r&&(wh(`https://${c}`),yh("Firestore",!0)),i.host!==Sg&&i.host!==c&&_n("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");const u={...i,host:c,ssl:r,emulatorOptions:o};if(!ft(u,s)&&(n._setSettings(u),o.mockUserToken)){let d,f;if(typeof o.mockUserToken=="string")d=o.mockUserToken,f=xe.MOCK_USER;else{d=_w(o.mockUserToken,n._app?.options.projectId);const g=o.mockUserToken.sub||o.mockUserToken.user_id;if(!g)throw new B(P.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");f=new xe(g)}n._authCredentials=new Kv(new ff(d,f))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We{constructor(e){this._byteString=e}static fromBase64String(e){try{return new We(Se.fromBase64String(e))}catch(t){throw new B(P.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new We(Se.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:We._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(pr(e,We._jsonSchema))return We.fromBase64String(e.bytes)}}We._jsonSchemaVersion="firestore/bytes/1.0",We._jsonSchema={type:_e("string",We._jsonSchemaVersion),bytes:_e("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new B(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ie(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nt{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new B(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new B(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Q(this._lat,e._lat)||Q(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:nt._jsonSchemaVersion}}static fromJSON(e){if(pr(e,nt._jsonSchema))return new nt(e.latitude,e.longitude)}}nt._jsonSchemaVersion="firestore/geoPoint/1.0",nt._jsonSchema={type:_e("string",nt._jsonSchemaVersion),latitude:_e("number"),longitude:_e("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ot{constructor(e){this._values=(e||[]).map(t=>t)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(o,r){if(o.length!==r.length)return!1;for(let i=0;i<o.length;++i)if(o[i]!==r[i])return!1;return!0}(this._values,e._values)}toJSON(){return{type:ot._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(pr(e,ot._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(t=>typeof t=="number"))return new ot(e.vectorValues);throw new B(P.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}ot._jsonSchemaVersion="firestore/vectorValue/1.0",ot._jsonSchema={type:_e("string",ot._jsonSchemaVersion),vectorValues:_e("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ir(n){return _o(n=Le(n,st)),new Gg(n,e=>bo(n,e))}(function(e,t=!0){(function(r){go=r})(ho),gt(new rt("firestore",(o,{instanceIdentifier:r,options:i})=>{const s=o.getProvider("app").getImmediate(),c=new st(new Qv(o.getProvider("auth-internal")),new Xv(s,o.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new B(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Yn(d.options.projectId,f)}(s,r),s);return i={useFetchStreams:t,...i},c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),Je(Ku,Qu,e),Je(Ku,Qu,"esm2020")})();const Ye=Object.freeze(Object.defineProperty({__proto__:null,AbstractUserDataWriter:Fg,Bytes:We,CollectionReference:St,DocumentReference:ae,DocumentSnapshot:qt,FieldPath:vo,FieldValue:Dn,Firestore:st,FirestoreError:B,GeoPoint:nt,Query:Nt,QueryCompositeFilterConstraint:ls,QueryConstraint:Lc,QueryDocumentSnapshot:Zo,QueryFieldFilterConstraint:Er,QueryOrderByConstraint:us,QuerySnapshot:jt,SnapshotMetadata:Fn,Timestamp:oe,VectorValue:ot,WriteBatch:Gg,_AutoId:qi,_ByteString:Se,_DatabaseId:Yn,_DocumentKey:F,_EmptyAuthCredentialsProvider:gf,_FieldPath:Ie,_cast:Le,_logWarn:_n,_validateIsNotUsedTogether:mf,addDoc:tn,arrayRemove:XT,arrayUnion:JT,collection:me,connectFirestoreEmulator:Ag,deleteDoc:Eo,doc:fe,ensureFirestoreConfigured:_o,executeWrite:bo,getDoc:br,getDocs:wt,getFirestore:Dg,onSnapshot:Tr,orderBy:Lg,query:Re,serverTimestamp:ds,setDoc:YT,updateDoc:en,where:Ae,writeBatch:Ir},Symbol.toStringTag,{value:"Module"})),zg="@firebase/installations",$c="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sp="installations",OI="installations-internal",VI=n=>{const e=n.getProvider("app").getImmediate(),t=MI(e),o=In(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:o,_delete:()=>Promise.resolve()}},xI=n=>{const e=n.getProvider("app").getImmediate(),t=In(e,sp).getImmediate();return{getId:()=>NI(t),getToken:r=>PI(t,r)}};function BI(){gt(new rt(sp,VI,"PUBLIC")),gt(new rt(OI,xI,"PRIVATE"))}BI();Je(zg,$c);Je(zg,$c,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oi="analytics",LI="firebase_id",UI="origin",FI=60*1e3,$I="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",jc="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
App Store: https://apps.apple.com/app/financeiro-servotech/id123456789`);return}if(e.textContent?.includes("Copiar Informações")){window.copyAppInfo();return}if(e.textContent?.includes("Limpar Cache Offline")){window.clearOfflineCache();return}if(e.textContent?.includes("O que mudou")){console.log('[DEBUG] Handler "O que mudou" executado!'),console.log("[DEBUG] Texto do elemento:",e.textContent),console.log("[DEBUG] Elemento completo:",e),console.log("[DEBUG] Chamando window.showWhatsNew()...");try{window.showWhatsNew(),console.log("[DEBUG] window.showWhatsNew() executado com sucesso"),O().success('Abrindo "O que mudou"...')}catch(g){console.error("[DEBUG] Erro ao executar showWhatsNew:",g),O().error('Erro ao abrir "O que mudou"')}return}if(e.textContent?.trim()==="O que mudou"||e.textContent?.includes("O que mudou")||e.getAttribute("data-action")==="whats-new"||e.classList?.contains("whats-new-btn")){console.log('[DEBUG] Handler adicional "O que mudou" executado!'),console.log("[DEBUG] Tipo de detecção:",{textTrim:e.textContent?.trim()==="O que mudou",textIncludes:e.textContent?.includes("O que mudou"),dataAction:e.getAttribute("data-action")==="whats-new",classList:e.classList?.contains("whats-new-btn")});try{window.showWhatsNew(),console.log("[DEBUG] Handler adicional executado com sucesso")}catch(g){console.error("[DEBUG] Erro no handler adicional:",g),O().error('Erro ao abrir "O que mudou"')}return}if(e.textContent?.includes("Instalar App")){window.installApp();return}if(e.id==="view-performance-events"){console.log("[DEBUG] Handler view-performance-events executado!"),R(()=>import("./perf-tobPnqr4.js"),[]).then(g=>{const m=g.getLog();if(console.log("[DEBUG] Eventos de performance coletados:",m),m.length===0){O().info("Nenhum evento de performance coletado ainda. Ative a telemetria e use o app para coletar dados.");return}console.table(m);const S=m.reduce((N,U)=>(N[U.event]=(N[U.event]||0)+1,N),{});console.log("[DEBUG] Resumo dos eventos:",S);const C=document.createElement("div");C.style.cssText=`
        ...
        `,k.innerHTML=`
          ...
          <ul>
            ${Object.entries(S).map(([N,U])=>`<li>${N}: ${U} ocorrências</li>`).join("")}
          </ul>

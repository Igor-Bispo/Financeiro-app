 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zh(n,e=[]){let t;switch(n){case"Browser":t=xu(Ue());break;case"Worker":t=`${xu(Ue())}-${n}`;break;default:t=n}const o=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${ho}/${o}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PE=new le(F.comparator);function Rt(){return PE}const Bf=new le(F.comparator);function zo(...n){let e=Bf;for(const t of n)e=e.insert(t.key,t);return e}function Lf(n){let e=Bf;return n.forEach((t,o)=>e=e.insert(t,o.overlayedDocument)),e}function hn(){return Jo()}function Uf(){return Jo()}function Jo(){return new Sn(n=>n.toString(),(n,e)=>n.isEqual(e))}const kE=new le(F.comparator),ME=new Ee(F.comparator);function Y(...n){let e=ME;for(const t of n)e=e.add(t);return e}const xE=new Ee(Q);function OE(){return xE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oe="WebChannelConnection";class Jb extends Qb{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,o,r,i){const s=ka();return new Promise((c,u)=>{const d=new af;d.setWithCredentials(!0),d.listenOnce(cf.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case ci.NO_ERROR:const g=d.getResponseJson();L(Oe,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(g)),c(g);break;case ci.TIMEOUT:L(Oe,`RPC '${e}' ${s} timed out`),u(new B(P.DEADLINE_EXCEEDED,"Request time out"));break;case ci.HTTP_ERROR:const m=d.getStatus();if(L(Oe,`RPC '${e}' ${s} failed with status:`,m,"response text:",d.getResponseText()),m>0){let I=d.getResponseJson();Array.isArray(I)&&(I=I[0]);const C=I?.error;if(C&&C.status&&C.message){const k=function(U){const $=U.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf($)>=0?$:P.UNKNOWN}(C.status);u(new B(k,C.message))}else u(new B(P.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new B(P.UNAVAILABLE,"Connection failed."));break;default:G(9055,{l_:e,streamId:s,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{L(Oe,`RPC '${e}' ${s} completed.`)}});const f=JSON.stringify(r);L(Oe,`RPC '${e}' ${s} sending request:`,r),d.send(t,"POST",f,o,15)})}T_(e,t,o){const r=ka(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],s=df(),c=uf(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,t,o),u.encodeInitMessageHeaders=!0;const f=i.join("");L(Oe,`Creating RPC '${e}' stream ${r}: ${f}`,u);const g=s.createWebChannel(f,u);this.I_(g);let m=!1,I=!1;const C=new Yb({Yo:N=>{I?L(Oe,`Not sending because RPC '${e}' stream ${r} is closed:`,N):(m||(L(Oe,`Opening RPC '${e}' stream ${r} transport.`),g.open(),m=!0),L(Oe,`RPC '${e}' stream ${r} sending:`,N),g.send(N))},Zo:()=>g.close()}),k=(N,U,$)=>{N.listen(U,W=>{try{$(W)}catch(ue){setTimeout(()=>{throw ue},0)}})};return k(g,Go.EventType.OPEN,()=>{I||(L(Oe,`RPC '${e}' stream ${r} transport opened.`),C.o_())}),k(g,Go.EventType.CLOSE,()=>{I||(I=!0,L(Oe,`RPC '${e}' stream ${r} transport closed`),C.a_(),this.E_(g))}),k(g,Go.EventType.ERROR,N=>{I||(I=!0,_n(Oe,`RPC '${e}' stream ${r} transport errored. Name:`,N.name,"Message:",N.message),C.a_(new B(P.UNAVAILABLE,"The operation could not be completed")))}),k(g,Go.EventType.MESSAGE,N=>{if(!I){const U=N.data[0];te(!!U,16349);const $=U,W=$?.error||$[0]?.error;if(W){L(Oe,`RPC '${e}' stream ${r} received error:`,W);const ue=W.status;let Ne=function(w){const _=we[w];if(_!==void 0)return Wf(_)}(ue),ie=W.message;Ne===void 0&&(Ne=P.INTERNAL,ie="Unknown error status: "+ue+" with message "+W.message),I=!0,C.a_(new B(Ne,ie)),g.close()}else L(Oe,`RPC '${e}' stream ${r} received:`,U),C.u_(U)}}),k(c,lf.STAT_EVENT,N=>{N.stat===_a.PROXY?L(Oe,`RPC '${e}' stream ${r} detected buffering proxy`):N.stat===_a.NOPROXY&&L(Oe,`RPC '${e}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{C.__()},0),C}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(t=>t===e)}}function ta(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xi="analytics",LI="firebase_id",UI="origin",FI=60*1e3,$I="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",qc="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
App Store: https://apps.apple.com/app/financeiro-servotech/id123456789`);return}if(e.textContent?.includes("Copiar Informações")){window.copyAppInfo();return}if(e.textContent?.includes("Limpar Cache Offline")){window.clearOfflineCache();return}if(e.textContent?.includes("O que mudou")){console.log('[DEBUG] Handler "O que mudou" executado!'),console.log("[DEBUG] Texto do elemento:",e.textContent),console.log("[DEBUG] Elemento completo:",e),console.log("[DEBUG] Chamando window.showWhatsNew()...");try{window.showWhatsNew(),console.log("[DEBUG] window.showWhatsNew() executado com sucesso"),x().success('Abrindo "O que mudou"...')}catch(g){console.error("[DEBUG] Erro ao executar showWhatsNew:",g),x().error('Erro ao abrir "O que mudou"')}return}if(e.textContent?.trim()==="O que mudou"||e.textContent?.includes("O que mudou")||e.getAttribute("data-action")==="whats-new"||e.classList?.contains("whats-new-btn")){console.log('[DEBUG] Handler adicional "O que mudou" executado!'),console.log("[DEBUG] Tipo de detecção:",{textTrim:e.textContent?.trim()==="O que mudou",textIncludes:e.textContent?.includes("O que mudou"),dataAction:e.getAttribute("data-action")==="whats-new",classList:e.classList?.contains("whats-new-btn")});try{window.showWhatsNew(),console.log("[DEBUG] Handler adicional executado com sucesso")}catch(g){console.error("[DEBUG] Erro no handler adicional:",g),x().error('Erro ao abrir "O que mudou"')}return}if(e.textContent?.includes("Instalar App")){window.installApp();return}if(e.id==="view-performance-events"){console.log("[DEBUG] Handler view-performance-events executado!"),R(()=>import("./perf-tobPnqr4.js"),[]).then(g=>{const m=g.getLog();if(console.log("[DEBUG] Eventos de performance coletados:",m),m.length===0){x().info("Nenhum evento de performance coletado ainda. Ative a telemetria e use o app para coletar dados.");return}console.table(m);const I=m.reduce((N,U)=>(N[U.event]=(N[U.event]||0)+1,N),{});console.log("[DEBUG] Resumo dos eventos:",I);const C=document.createElement("div");C.style.cssText=`
        ...
        `,k.innerHTML=`
          ...
          <ul>
            ${Object.entries(I).map(([N,U])=>`<li>${N}: ${U} ocorrências</li>`).join("")}
          </ul>

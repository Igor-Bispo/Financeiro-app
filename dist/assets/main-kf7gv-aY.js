const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D0LlixA1.js","assets/PeriodIndicator-DUMQe4l_.js","assets/TransactionsPage-Csxr-yTe.js","assets/UIService-CWt7M93N.js","assets/perf-tobPnqr4.js","assets/CategoriesPage-CrYUw8Df.js","assets/NotificationsPage-DWMY8ZTL.js","assets/NotificationModal-CIwGxTmq.js","assets/NotificationService-DGgpx5ox.js","assets/VoiceService-F1rMbtYP.js","assets/VoiceSystem-CEBe8orV.js","assets/AuthService-DnDSiW_2.js"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();const aw="modulepreload",cw=function(n){return"/"+n},wu={},R=function(e,t,o){let r=Promise.resolve();if(t&&t.length>0){let u=function(d){return Promise.all(d.map(f=>Promise.resolve(f).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),c=s?.nonce||s?.getAttribute("nonce");r=u(t.map(d=>{if(d=cw(d),d in wu)return;wu[d]=!0;const f=d.endsWith(".css"),g=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${g}`))return;const m=document.createElement("link");if(m.rel=f?"stylesheet":aw,f||(m.as="script"),m.crossOrigin="",m.href=d,c&&m.setAttribute("nonce",c),document.head.appendChild(m),f)return new Promise((S,C)=>{m.addEventListener("load",S),m.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${d}`)))})}))}function i(s){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=s,window.dispatchEvent(c),!c.defaultPrevented)throw s}return r.then(s=>{for(const c of s||[])c.status==="rejected"&&i(c.reason);return e().catch(i)})},lw=()=>{};var yu={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Le(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function bw(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Le())}function Tw(){const n=Li()?.forceEnvironment;if(n==="node")return!0;if(n==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Iw(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function _h(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Sw(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Aw(){const n=Le();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Dw(){return!Tw()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function vh(){try{return typeof indexedDB=="object"}catch{return!1}}function Eh(){return new Promise((n,e)=>{try{let t=!0;const o="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(o);r.onsuccess=()=>{r.result.close(),t||self.indexedDB.deleteDatabase(o),n(!0)},r.onupgradeneeded=()=>{t=!1},r.onerror=()=>{e(r.error?.message||"")}}catch(t){e(t)}})}function Cw(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bw=1e3,xw=2,Uw=14400*1e3,Lw=.5;function Eu(n,e=Bw,t=xw){const o=e*Math.pow(t,n),r=Math.round(Lw*o*(Math.random()-.5)*2);return Math.min(Uw,o+r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ga="[DEFAULT]",My={[fa]:"fire-core",[sy]:"fire-core-compat",[cy]:"fire-analytics",[ay]:"fire-analytics-compat",[uy]:"fire-app-check",[ly]:"fire-app-check-compat",[dy]:"fire-auth",[hy]:"fire-auth-compat",[fy]:"fire-rtdb",[gy]:"fire-data-connect",[py]:"fire-rtdb-compat",[my]:"fire-fn",[wy]:"fire-fn-compat",[yy]:"fire-iid",[_y]:"fire-iid-compat",[vy]:"fire-fcm",[Ey]:"fire-fcm-compat",[by]:"fire-perf",[Ty]:"fire-perf-compat",[Iy]:"fire-rc",[Sy]:"fire-rc-compat",[Ay]:"fire-gcs",[Dy]:"fire-gcs-compat",[Cy]:"fire-fst",[Ny]:"fire-fst-compat",[Ry]:"fire-vertex","fire-js":"fire-js",[Py]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fy=1024,$y=30;class Gy{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new qy(t),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Cu();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(r=>r.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:t}),this._heartbeatsCache.heartbeats.length>$y){const r=jy(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){At.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Cu(),{heartbeatsToSend:t,unsentEntries:o}=zy(this._heartbeatsCache.heartbeats),r=gi(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,o.length>0?(this._heartbeatsCache.heartbeats=o,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(e){return At.warn(e),""}}}function Cu(){return new Date().toISOString().substring(0,10)}function zy(n,e=Fy){const t=[];let o=n.slice();for(const r of n){const i=t.find(s=>s.agent===r.agent);if(i){if(i.dates.push(r.date),Ru(t)>e){i.dates.pop();break}}else if(t.push({agent:r.agent,dates:[r.date]}),Ru(t)>e){t.pop();break}o=o.slice(1)}return{heartbeatsToSend:t,unsentEntries:o}}class qy{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return vh()?Eh().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Ly(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const o=await this.read();return Du(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??o.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const o=await this.read();return Du(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??o.lastSentHeartbeatDate,heartbeats:[...o.heartbeats,...e.heartbeats]})}else return}}function Ru(n){return gi(JSON.stringify({version:2,heartbeats:n})).length}function jy(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let o=1;o<n.length;o++)n[o].date<t&&(t=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yi(n){const e=n.auth,t=await n.getIdToken(),o=await rr(n,wi(e,{idToken:t}));z(o?.users.length,e,"internal-error");const r=o.users[0];n._notifyReloadListener(r);const i=r.providerUserInfo?.length?Mh(r.providerUserInfo):[],s=d_(n.providerData,i),c=n.isAnonymous,u=!(n.email&&r.passwordHash)&&!s?.length,d=c?u:!1,f={uid:r.localId,displayName:r.displayName||null,photoURL:r.photoUrl||null,email:r.email||null,emailVerified:r.emailVerified||!1,phoneNumber:r.phoneNumber||null,tenantId:r.tenantId||null,providerData:s,metadata:new wa(r.createdAt,r.lastLoginAt),isAnonymous:d};Object.assign(n,f)}async function u_(n){const e=he(n);await yi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function d_(n,e){return[...n.filter(o=>!e.some(r=>r.providerId===o.providerId)),...e]}function Mh(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ou(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Uh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Vh(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Fh(e))return"Blackberry";if($h(e))return"Webos";if(Bh(e))return"Safari";if((e.includes("chrome/")||xh(e))&&!e.includes("edge/"))return"Chrome";if(Lh(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,o=n.match(t);if(o?.length===2)return o[1]}return"Other"}function Vh(n=Le()){return/firefox\//i.test(n)}function Bh(n=Le()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function xh(n=Le()){return/crios\//i.test(n)}function Uh(n=Le()){return/iemobile/i.test(n)}function Lh(n=Le()){return/android/i.test(n)}function Fh(n=Le()){return/blackberry/i.test(n)}function $h(n=Le()){return/webos/i.test(n)}function Xa(n=Le()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function g_(n=Le()){return Xa(n)&&!!window.navigator?.standalone}function p_(){return Aw()&&document.documentMode===10}function Gh(n=Le()){return Xa(n)||Lh(n)||$h(n)||Fh(n)||/windows phone/i.test(n)||Uh(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function M_(n,e,t=!1){if(Ze(n.app))return Promise.reject(pn(n));const o="signIn",r=await Hh(n,o,e),i=await Kn._fromIdTokenResponse(n,o,r);return t||await n._updateCurrentUser(i.user),i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O_(n,e){return he(n).setPersistence(e)}function V_(n,e,t,o){return he(n).onIdTokenChanged(e,t,o)}function B_(n,e,t){return he(n).beforeAuthStateChanged(e,t)}function x_(n,e,t,o){return he(n).onAuthStateChanged(e,t,o)}const vi="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xh(){return typeof ut().WorkerGlobalScope<"u"&&typeof ut().importScripts=="function"}async function z_(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function q_(){return navigator?.serviceWorker?.controller||null}function j_(){return Xh()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ov="__/auth/handler",Vv="emulator/auth/handler",Bv=encodeURIComponent("fac");async function zu(n,e,t,o,r,i){z(n.config.authDomain,n,"auth-domain-config-required"),z(n.config.apiKey,n,"invalid-api-key");const s={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:o,v:ho,eventId:r};if(e instanceof ec){e.setDefaultLanguage(n.languageCode),s.providerId=e.providerId||"",kw(e.getCustomParameters())||(s.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,g]of Object.entries({}))s[f]=g}if(e instanceof fr){const f=e.getScopes().filter(g=>g!=="");f.length>0&&(s.scopes=f.join(","))}n.tenantId&&(s.tid=n.tenantId);const c=s;for(const f of Object.keys(c))c[f]===void 0&&delete c[f];const u=await n._getAppCheckToken(),d=u?`#${Bv}=${encodeURIComponent(u)}`:"";return`${xv(n)}?${dr(c).slice(1)}${d}`}function xv({config:n}){return n.emulator?Qa(n,Vv):`https://${n.authDomain}/${Ov}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zv=300,qv=mh("authIdTokenMaxAge")||zv;let Hu=null;const jv=n=>async e=>{const t=e&&await e.getIdTokenResult(),o=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(o&&o>qv)return;const r=t?.token;Hu!==r&&(Hu=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function Hv(n=Ha()){const e=In(n,"auth");if(e.isInitialized())return e.getImmediate();const t=S_(n,{popupRedirectResolver:Lv,persistence:[J_,Qh,Jh]}),o=mh("authTokenSyncURL");if(o&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(o,location.origin);if(location.origin===i.origin){const s=jv(i.toString());B_(t,s,()=>s(t.currentUser)),V_(t,c=>s(c))}}const r=gh("auth");return r&&D_(t,`http://${r}`),t}function Wv(){return document.getElementsByTagName("head")?.[0]??document}E_({loadJS(n){return new Promise((e,t)=>{const o=document.createElement("script");o.setAttribute("src",n),o.onload=e,o.onerror=r=>{const i=tt("internal-error");i.customData=r,t(i)},o.type="text/javascript",o.charset="UTF-8",Wv().appendChild(o)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Gv("Browser");var Wu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var af,Go,cf,ci,_a,lf,uf,df;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,l,h){return a==Array.prototype||a==Object.prototype||(a[l]=h.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Qr=="object"&&Qr];for(var l=0;l<a.length;++l){var h=a[l];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var o=t(this);function r(a,l){if(l)e:{var h=o;a=a.split(".");for(var p=0;p<a.length-1;p++){var T=a[p];if(!(T in h))break e;h=h[T]}a=a[a.length-1],p=h[a],l=l(p),l!=p&&l!=null&&e(h,a,{configurable:!0,writable:!0,value:l})}}function i(a,l){a instanceof String&&(a+="");var h=0,p=!1,T={next:function(){if(!p&&h<a.length){var D=h++;return{value:l(D,a[D]),done:!1}}return p=!0,{done:!0,value:void 0}}};return T[Symbol.iterator]=function(){return T},T}r("Array.prototype.values",function(a){return a||function(){return i(this,function(l,h){return h})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var s=s||{},c=this||self;function u(a){var l=typeof a;return l=l!="object"?l:a?Array.isArray(a)?"array":l:"null",l=="array"||l=="object"&&typeof a.length=="number"}function d(a){var l=typeof a;return l=="object"&&a!=null||l=="function"}function f(a,l,h){return a.call.apply(a.bind,arguments)}function g(a,l,h){if(!a)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var T=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(T,p),a.apply(l,T)}}return function(){return a.apply(l,arguments)}}function m(a,l,h){return m=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:g,m.apply(null,arguments)}function S(a,l){var h=Array.prototype.slice.call(arguments,1);return function(){var p=h.slice();return p.push.apply(p,arguments),a.apply(this,p)}}function C(a,l){function h(){}h.prototype=l.prototype,a.aa=l.prototype,a.prototype=new h,a.prototype.constructor=a,a.Qb=function(p,T,D){for(var V=Array(arguments.length-2),ne=2;ne<arguments.length;ne++)V[ne-2]=arguments[ne];return l.prototype[T].apply(p,V)}}function k(a){const l=a.length;if(0<l){const h=Array(l);for(let p=0;p<l;p++)h[p]=a[p];return h}return[]}function P(a,l){for(let h=1;h<arguments.length;h++){const p=arguments[h];if(u(p)){const T=a.length||0,D=p.length||0;a.length=T+D;for(let V=0;V<D;V++)a[T+V]=p[V]}else a.push(p)}}class L{constructor(l,h){this.i=l,this.j=h,this.h=0,this.g=null}get(){let l;return 0<this.h?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function $(a){return/^[\s\xa0]*$/.test(a)}function W(){var a=c.navigator;return a&&(a=a.userAgent)?a:""}function ue(a){return ue[" "](a),a}ue[" "]=function(){};var Ne=W().indexOf("Gecko")!=-1&&!(W().toLowerCase().indexOf("webkit")!=-1&&W().indexOf("Edge")==-1)&&!(W().indexOf("Trident")!=-1||W().indexOf("MSIE")!=-1)&&W().indexOf("Edge")==-1;function ie(a,l,h){for(const p in a)l.call(h,a[p],p,a)}function b(a,l){for(const h in a)l.call(void 0,a[h],h,a)}function w(a){const l={};for(const h in a)l[h]=a[h];return l}const _="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function v(a,l){let h,p;for(let T=1;T<arguments.length;T++){p=arguments[T];for(h in p)a[h]=p[h];for(let D=0;D<_.length;D++)h=_[D],Object.prototype.hasOwnProperty.call(p,h)&&(a[h]=p[h])}}function E(a){var l=1;a=a.split(":");const h=[];for(;0<l&&a.length;)h.push(a.shift()),l--;return a.length&&h.push(a.join(":")),h}function I(a){c.setTimeout(()=>{throw a},0)}function y(){var a=Es;let l=null;return a.g&&(l=a.g,a.g=a.g.next,a.g||(a.h=null),l.next=null),l}class yt{constructor(){this.h=this.g=null}add(l,h){const p=So.get();p.set(l,h),this.h?this.h.next=p:this.g=p,this.h=p}}var So=new L(()=>new Am,a=>a.reset());class Am{constructor(){this.next=this.g=this.h=null}set(l,h){this.h=l,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let Ao,Do=!1,Es=new yt,wl=()=>{const a=c.Promise.resolve(void 0);Ao=()=>{a.then(Dm)}};var Dm=()=>{for(var a;a=y();){try{a.h.call(a.g)}catch(h){I(h)}var l=So;l.j(a),100>l.h&&(l.h++,a.next=l.g,l.g=a)}Do=!1};function Pt(){this.s=this.s,this.C=this.C}Pt.prototype.s=!1,Pt.prototype.ma=function(){this.s||(this.s=!0,this.N())},Pt.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Pe(a,l){this.type=a,this.g=this.target=l,this.defaultPrevented=!1}Pe.prototype.h=function(){this.defaultPrevented=!0};var Cm=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var a=!1,l=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const h=()=>{};c.addEventListener("test",h,l),c.removeEventListener("test",h,l)}catch{}return a}();function Co(a,l){if(Pe.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var h=this.type=a.type,p=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=l,l=a.relatedTarget){if(Ne){e:{try{ue(l.nodeName);var T=!0;break e}catch{}T=!1}T||(l=null)}}else h=="mouseover"?l=a.fromElement:h=="mouseout"&&(l=a.toElement);this.relatedTarget=l,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:Rm[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&Co.aa.h.call(this)}}C(Co,Pe);var Rm={2:"touch",3:"pen",4:"mouse"};Co.prototype.h=function(){Co.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Rr="closure_listenable_"+(1e6*Math.random()|0),Nm=0;function Pm(a,l,h,p,T){this.listener=a,this.proxy=null,this.src=l,this.type=h,this.capture=!!p,this.ha=T,this.key=++Nm,this.da=this.fa=!1}function Nr(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Pr(a){this.src=a,this.g={},this.h=0}Pr.prototype.add=function(a,l,h,p,T){var D=a.toString();a=this.g[D],a||(a=this.g[D]=[],this.h++);var V=Ts(a,l,p,T);return-1<V?(l=a[V],h||(l.fa=!1)):(l=new Pm(l,this.src,D,!!p,T),l.fa=h,a.push(l)),l};function bs(a,l){var h=l.type;if(h in a.g){var p=a.g[h],T=Array.prototype.indexOf.call(p,l,void 0),D;(D=0<=T)&&Array.prototype.splice.call(p,T,1),D&&(Nr(l),a.g[h].length==0&&(delete a.g[h],a.h--))}}function Ts(a,l,h,p){for(var T=0;T<a.length;++T){var D=a[T];if(!D.da&&D.listener==l&&D.capture==!!h&&D.ha==p)return T}return-1}var Is="closure_lm_"+(1e6*Math.random()|0),Ss={};function yl(a,l,h,p,T){if(Array.isArray(l)){for(var D=0;D<l.length;D++)yl(a,l[D],h,p,T);return null}return h=El(h),a&&a[Rr]?a.K(l,h,d(p)?!!p.capture:!1,T):km(a,l,h,!1,p,T)}function km(a,l,h,p,T,D){if(!l)throw Error("Invalid event type");var V=d(T)?!!T.capture:!!T,ne=Ds(a);if(ne||(a[Is]=ne=new Pr(a)),h=ne.add(l,h,p,V,D),h.proxy)return h;if(p=Mm(),h.proxy=p,p.src=a,p.listener=h,a.addEventListener)Cm||(T=V),T===void 0&&(T=!1),a.addEventListener(l.toString(),p,T);else if(a.attachEvent)a.attachEvent(vl(l.toString()),p);else if(a.addListener&&a.removeListener)a.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return h}function Mm(){function a(h){return l.call(a.src,a.listener,h)}const l=Om;return a}function _l(a,l,h,p,T){if(Array.isArray(l))for(var D=0;D<l.length;D++)_l(a,l[D],h,p,T);else p=d(p)?!!p.capture:!!p,h=El(h),a&&a[Rr]?(a=a.i,l=String(l).toString(),l in a.g&&(D=a.g[l],h=Ts(D,h,p,T),-1<h&&(Nr(D[h]),Array.prototype.splice.call(D,h,1),D.length==0&&(delete a.g[l],a.h--)))):a&&(a=Ds(a))&&(l=a.g[l.toString()],a=-1,l&&(a=Ts(l,h,p,T)),(h=-1<a?l[a]:null)&&As(h))}function As(a){if(typeof a!="number"&&a&&!a.da){var l=a.src;if(l&&l[Rr])bs(l.i,a);else{var h=a.type,p=a.proxy;l.removeEventListener?l.removeEventListener(h,p,a.capture):l.detachEvent?l.detachEvent(vl(h),p):l.addListener&&l.removeListener&&l.removeListener(p),(h=Ds(l))?(bs(h,a),h.h==0&&(h.src=null,l[Is]=null)):Nr(a)}}}function vl(a){return a in Ss?Ss[a]:Ss[a]="on"+a}function Om(a,l){if(a.da)a=!0;else{l=new Co(l,this);var h=a.listener,p=a.ha||a.src;a.fa&&As(a),a=h.call(p,l)}return a}function Ds(a){return a=a[Is],a instanceof Pr?a:null}var Cs="__closure_events_fn_"+(1e9*Math.random()>>>0);function El(a){return typeof a=="function"?a:(a[Cs]||(a[Cs]=function(l){return a.handleEvent(l)}),a[Cs])}function ke(){Pt.call(this),this.i=new Pr(this),this.M=this,this.F=null}C(ke,Pt),ke.prototype[Rr]=!0,ke.prototype.removeEventListener=function(a,l,h,p){_l(this,a,l,h,p)};function Fe(a,l){var h,p=a.F;if(p)for(h=[];p;p=p.F)h.push(p);if(a=a.M,p=l.type||l,typeof l=="string")l=new Pe(l,a);else if(l instanceof Pe)l.target=l.target||a;else{var T=l;l=new Pe(p,a),v(l,T)}if(T=!0,h)for(var D=h.length-1;0<=D;D--){var V=l.g=h[D];T=kr(V,p,!0,l)&&T}if(V=l.g=a,T=kr(V,p,!0,l)&&T,T=kr(V,p,!1,l)&&T,h)for(D=0;D<h.length;D++)V=l.g=h[D],T=kr(V,p,!1,l)&&T}ke.prototype.N=function(){if(ke.aa.N.call(this),this.i){var a=this.i,l;for(l in a.g){for(var h=a.g[l],p=0;p<h.length;p++)Nr(h[p]);delete a.g[l],a.h--}}this.F=null},ke.prototype.K=function(a,l,h,p){return this.i.add(String(a),l,!1,h,p)},ke.prototype.L=function(a,l,h,p){return this.i.add(String(a),l,!0,h,p)};function kr(a,l,h,p){if(l=a.i.g[String(l)],!l)return!0;l=l.concat();for(var T=!0,D=0;D<l.length;++D){var V=l[D];if(V&&!V.da&&V.capture==h){var ne=V.listener,De=V.ha||V.src;V.fa&&bs(a.i,V),T=ne.call(De,p)!==!1&&T}}return T&&!p.defaultPrevented}function bl(a,l,h){if(typeof a=="function")h&&(a=m(a,h));else if(a&&typeof a.handleEvent=="function")a=m(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(l)?-1:c.setTimeout(a,l||0)}function Tl(a){a.g=bl(()=>{a.g=null,a.i&&(a.i=!1,Tl(a))},a.l);const l=a.h;a.h=null,a.m.apply(null,l)}class Vm extends Pt{constructor(l,h){super(),this.m=l,this.l=h,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:Tl(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Ro(a){Pt.call(this),this.h=a,this.g={}}C(Ro,Pt);var Il=[];function Sl(a){ie(a.g,function(l,h){this.g.hasOwnProperty(h)&&As(l)},a),a.g={}}Ro.prototype.N=function(){Ro.aa.N.call(this),Sl(this)},Ro.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Rs=c.JSON.stringify,Bm=c.JSON.parse,xm=class{stringify(a){return c.JSON.stringify(a,void 0)}parse(a){return c.JSON.parse(a,void 0)}};function Ns(){}Ns.prototype.h=null;function Al(a){return a.h||(a.h=a.i())}function Dl(){}var No={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Ps(){Pe.call(this,"d")}C(Ps,Pe);function ks(){Pe.call(this,"c")}C(ks,Pe);var nn={},Cl=null;function Mr(){return Cl=Cl||new ke}nn.La="serverreachability";function Rl(a){Pe.call(this,nn.La,a)}C(Rl,Pe);function Po(a){const l=Mr();Fe(l,new Rl(l))}nn.STAT_EVENT="statevent";function Nl(a,l){Pe.call(this,nn.STAT_EVENT,a),this.stat=l}C(Nl,Pe);function $e(a){const l=Mr();Fe(l,new Nl(l,a))}nn.Ma="timingevent";function Pl(a,l){Pe.call(this,nn.Ma,a),this.size=l}C(Pl,Pe);function ko(a,l){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){a()},l)}function Mo(){this.g=!0}Mo.prototype.xa=function(){this.g=!1};function Um(a,l,h,p,T,D){a.info(function(){if(a.g)if(D)for(var V="",ne=D.split("&"),De=0;De<ne.length;De++){var Z=ne[De].split("=");if(1<Z.length){var Me=Z[0];Z=Z[1];var Oe=Me.split("_");V=2<=Oe.length&&Oe[1]=="type"?V+(Me+"="+Z+"&"):V+(Me+"=redacted&")}}else V=null;else V=D;return"XMLHTTP REQ ("+p+") [attempt "+T+"]: "+l+`
`+h+`
`+V})}function Lm(a,l,h,p,T,D,V){a.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+T+"]: "+l+`
`+h+`
`+D+" "+V})}function kn(a,l,h,p){a.info(function(){return"XMLHTTP TEXT ("+l+"): "+$m(a,h)+(p?" "+p:"")})}function Fm(a,l){a.info(function(){return"TIMEOUT: "+l})}Mo.prototype.info=function(){};function $m(a,l){if(!a.g)return l;if(!l)return null;try{var h=JSON.parse(l);if(h){for(a=0;a<h.length;a++)if(Array.isArray(h[a])){var p=h[a];if(!(2>p.length)){var T=p[1];if(Array.isArray(T)&&!(1>T.length)){var D=T[0];if(D!="noop"&&D!="stop"&&D!="close")for(var V=1;V<T.length;V++)T[V]=""}}}}return Rs(h)}catch{return l}}var Or={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},kl={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Ms;function Vr(){}C(Vr,Ns),Vr.prototype.g=function(){return new XMLHttpRequest},Vr.prototype.i=function(){return{}},Ms=new Vr;function kt(a,l,h,p){this.j=a,this.i=l,this.l=h,this.R=p||1,this.U=new Ro(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Ml}function Ml(){this.i=null,this.g="",this.h=!1}var Ol={},Os={};function Vs(a,l,h){a.L=1,a.v=Lr(_t(l)),a.m=h,a.P=!0,Vl(a,null)}function Vl(a,l){a.F=Date.now(),Br(a),a.A=_t(a.v);var h=a.A,p=a.R;Array.isArray(p)||(p=[String(p)]),Ql(h.i,"t",p),a.C=0,h=a.j.J,a.h=new Ml,a.g=fu(a.j,h?l:null,!a.m),0<a.O&&(a.M=new Vm(m(a.Y,a,a.g),a.O)),l=a.U,h=a.g,p=a.ca;var T="readystatechange";Array.isArray(T)||(T&&(Il[0]=T.toString()),T=Il);for(var D=0;D<T.length;D++){var V=yl(h,T[D],p||l.handleEvent,!1,l.h||l);if(!V)break;l.g[V.key]=V}l=a.H?w(a.H):{},a.m?(a.u||(a.u="POST"),l["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,l)):(a.u="GET",a.g.ea(a.A,a.u,null,l)),Po(),Um(a.i,a.u,a.A,a.l,a.R,a.m)}kt.prototype.ca=function(a){a=a.target;const l=this.M;l&&vt(a)==3?l.j():this.Y(a)},kt.prototype.Y=function(a){try{if(a==this.g)e:{const Oe=vt(this.g);var l=this.g.Ba();const Vn=this.g.Z();if(!(3>Oe)&&(Oe!=3||this.g&&(this.h.h||this.g.oa()||nu(this.g)))){this.J||Oe!=4||l==7||(l==8||0>=Vn?Po(3):Po(2)),Bs(this);var h=this.g.Z();this.X=h;t:if(Bl(this)){var p=nu(this.g);a="";var T=p.length,D=vt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){on(this),Oo(this);var V="";break t}this.h.i=new c.TextDecoder}for(l=0;l<T;l++)this.h.h=!0,a+=this.h.i.decode(p[l],{stream:!(D&&l==T-1)});p.length=0,this.h.g+=a,this.C=0,V=this.h.g}else V=this.g.oa();if(this.o=h==200,Lm(this.i,this.u,this.A,this.l,this.R,Oe,h),this.o){if(this.T&&!this.K){t:{if(this.g){var ne,De=this.g;if((ne=De.g?De.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!$(ne)){var Z=ne;break t}}Z=null}if(h=Z)kn(this.i,this.l,h,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,xs(this,h);else{this.o=!1,this.s=3,$e(12),on(this),Oo(this);break e}}if(this.P){h=!0;let Xe;for(;!this.J&&this.C<V.length;)if(Xe=Gm(this,V),Xe==Os){Oe==4&&(this.s=4,$e(14),h=!1),kn(this.i,this.l,null,"[Incomplete Response]");break}else if(Xe==Ol){this.s=4,$e(15),kn(this.i,this.l,V,"[Invalid Chunk]"),h=!1;break}else kn(this.i,this.l,Xe,null),xs(this,Xe);if(Bl(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Oe!=4||V.length!=0||this.h.h||(this.s=1,$e(16),h=!1),this.o=this.o&&h,!h)kn(this.i,this.l,V,"[Invalid Chunked Response]"),on(this),Oo(this);else if(0<V.length&&!this.W){this.W=!0;var Me=this.j;Me.g==this&&Me.ba&&!Me.M&&(Me.j.info("Great, no buffering proxy detected. Bytes received: "+V.length),zs(Me),Me.M=!0,$e(11))}}else kn(this.i,this.l,V,null),xs(this,V);Oe==4&&on(this),this.o&&!this.J&&(Oe==4?lu(this.j,this):(this.o=!1,Br(this)))}else iw(this.g),h==400&&0<V.indexOf("Unknown SID")?(this.s=3,$e(12)):(this.s=0,$e(13)),on(this),Oo(this)}}}catch{}finally{}};function Bl(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function Gm(a,l){var h=a.C,p=l.indexOf(`
`,h);return p==-1?Os:(h=Number(l.substring(h,p)),isNaN(h)?Ol:(p+=1,p+h>l.length?Os:(l=l.slice(p,p+h),a.C=p+h,l)))}kt.prototype.cancel=function(){this.J=!0,on(this)};function Br(a){a.S=Date.now()+a.I,xl(a,a.I)}function xl(a,l){if(a.B!=null)throw Error("WatchDog timer not null");a.B=ko(m(a.ba,a),l)}function Bs(a){a.B&&(c.clearTimeout(a.B),a.B=null)}kt.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(Fm(this.i,this.A),this.L!=2&&(Po(),$e(17)),on(this),this.s=2,Oo(this)):xl(this,this.S-a)};function Oo(a){a.j.G==0||a.J||lu(a.j,a)}function on(a){Bs(a);var l=a.M;l&&typeof l.ma=="function"&&l.ma(),a.M=null,Sl(a.U),a.g&&(l=a.g,a.g=null,l.abort(),l.ma())}function xs(a,l){try{var h=a.j;if(h.G!=0&&(h.g==a||Us(h.h,a))){if(!a.K&&Us(h.h,a)&&h.G==3){try{var p=h.Da.g.parse(l)}catch{p=null}if(Array.isArray(p)&&p.length==3){var T=p;if(T[0]==0){e:if(!h.u){if(h.g)if(h.g.F+3e3<a.F)jr(h),zr(h);else break e;Gs(h),$e(18)}}else h.za=T[1],0<h.za-h.T&&37500>T[2]&&h.F&&h.v==0&&!h.C&&(h.C=ko(m(h.Za,h),6e3));if(1>=Fl(h.h)&&h.ca){try{h.ca()}catch{}h.ca=void 0}}else sn(h,11)}else if((a.K||h.g==a)&&jr(h),!$(l))for(T=h.Da.g.parse(l),l=0;l<T.length;l++){let Z=T[l];if(h.T=Z[0],Z=Z[1],h.G==2)if(Z[0]=="c"){h.K=Z[1],h.ia=Z[2];const Me=Z[3];Me!=null&&(h.la=Me,h.j.info("VER="+h.la));const Oe=Z[4];Oe!=null&&(h.Aa=Oe,h.j.info("SVER="+h.Aa));const Vn=Z[5];Vn!=null&&typeof Vn=="number"&&0<Vn&&(p=1.5*Vn,h.L=p,h.j.info("backChannelRequestTimeoutMs_="+p)),p=h;const Xe=a.g;if(Xe){const Wr=Xe.g?Xe.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Wr){var D=p.h;D.g||Wr.indexOf("spdy")==-1&&Wr.indexOf("quic")==-1&&Wr.indexOf("h2")==-1||(D.j=D.l,D.g=new Set,D.h&&(Ls(D,D.h),D.h=null))}if(p.D){const qs=Xe.g?Xe.g.getResponseHeader("X-HTTP-Session-Id"):null;qs&&(p.ya=qs,se(p.I,p.D,qs))}}h.G=3,h.l&&h.l.ua(),h.ba&&(h.R=Date.now()-a.F,h.j.info("Handshake RTT: "+h.R+"ms")),p=h;var V=a;if(p.qa=hu(p,p.J?p.ia:null,p.W),V.K){$l(p.h,V);var ne=V,De=p.L;De&&(ne.I=De),ne.B&&(Bs(ne),Br(ne)),p.g=V}else au(p);0<h.i.length&&qr(h)}else Z[0]!="stop"&&Z[0]!="close"||sn(h,7);else h.G==3&&(Z[0]=="stop"||Z[0]=="close"?Z[0]=="stop"?sn(h,7):$s(h):Z[0]!="noop"&&h.l&&h.l.ta(Z),h.v=0)}}Po(4)}catch{}}var zm=class{constructor(a,l){this.g=a,this.map=l}};function Ul(a){this.l=a||10,c.PerformanceNavigationTiming?(a=c.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Ll(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Fl(a){return a.h?1:a.g?a.g.size:0}function Us(a,l){return a.h?a.h==l:a.g?a.g.has(l):!1}function Ls(a,l){a.g?a.g.add(l):a.h=l}function $l(a,l){a.h&&a.h==l?a.h=null:a.g&&a.g.has(l)&&a.g.delete(l)}Ul.prototype.cancel=function(){if(this.i=Gl(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Gl(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let l=a.i;for(const h of a.g.values())l=l.concat(h.D);return l}return k(a.i)}function qm(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(u(a)){for(var l=[],h=a.length,p=0;p<h;p++)l.push(a[p]);return l}l=[],h=0;for(p in a)l[h++]=a[p];return l}function jm(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(u(a)||typeof a=="string"){var l=[];a=a.length;for(var h=0;h<a;h++)l.push(h);return l}l=[],h=0;for(const p in a)l[h++]=p;return l}}}function zl(a,l){if(a.forEach&&typeof a.forEach=="function")a.forEach(l,void 0);else if(u(a)||typeof a=="string")Array.prototype.forEach.call(a,l,void 0);else for(var h=jm(a),p=qm(a),T=p.length,D=0;D<T;D++)l.call(void 0,p[D],h&&h[D],a)}var ql=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Hm(a,l){if(a){a=a.split("&");for(var h=0;h<a.length;h++){var p=a[h].indexOf("="),T=null;if(0<=p){var D=a[h].substring(0,p);T=a[h].substring(p+1)}else D=a[h];l(D,T?decodeURIComponent(T.replace(/\+/g," ")):"")}}}function rn(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof rn){this.h=a.h,xr(this,a.j),this.o=a.o,this.g=a.g,Ur(this,a.s),this.l=a.l;var l=a.i,h=new xo;h.i=l.i,l.g&&(h.g=new Map(l.g),h.h=l.h),jl(this,h),this.m=a.m}else a&&(l=String(a).match(ql))?(this.h=!1,xr(this,l[1]||"",!0),this.o=Vo(l[2]||""),this.g=Vo(l[3]||"",!0),Ur(this,l[4]),this.l=Vo(l[5]||"",!0),jl(this,l[6]||"",!0),this.m=Vo(l[7]||"")):(this.h=!1,this.i=new xo(null,this.h))}rn.prototype.toString=function(){var a=[],l=this.j;l&&a.push(Bo(l,Hl,!0),":");var h=this.g;return(h||l=="file")&&(a.push("//"),(l=this.o)&&a.push(Bo(l,Hl,!0),"@"),a.push(encodeURIComponent(String(h)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.s,h!=null&&a.push(":",String(h))),(h=this.l)&&(this.g&&h.charAt(0)!="/"&&a.push("/"),a.push(Bo(h,h.charAt(0)=="/"?Qm:Km,!0))),(h=this.i.toString())&&a.push("?",h),(h=this.m)&&a.push("#",Bo(h,Jm)),a.join("")};function _t(a){return new rn(a)}function xr(a,l,h){a.j=h?Vo(l,!0):l,a.j&&(a.j=a.j.replace(/:$/,""))}function Ur(a,l){if(l){if(l=Number(l),isNaN(l)||0>l)throw Error("Bad port number "+l);a.s=l}else a.s=null}function jl(a,l,h){l instanceof xo?(a.i=l,Xm(a.i,a.h)):(h||(l=Bo(l,Ym)),a.i=new xo(l,a.h))}function se(a,l,h){a.i.set(l,h)}function Lr(a){return se(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function Vo(a,l){return a?l?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Bo(a,l,h){return typeof a=="string"?(a=encodeURI(a).replace(l,Wm),h&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function Wm(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Hl=/[#\/\?@]/g,Km=/[#\?:]/g,Qm=/[#\?]/g,Ym=/[#\?@]/g,Jm=/#/g;function xo(a,l){this.h=this.g=null,this.i=a||null,this.j=!!l}function Mt(a){a.g||(a.g=new Map,a.h=0,a.i&&Hm(a.i,function(l,h){a.add(decodeURIComponent(l.replace(/\+/g," ")),h)}))}n=xo.prototype,n.add=function(a,l){Mt(this),this.i=null,a=Mn(this,a);var h=this.g.get(a);return h||this.g.set(a,h=[]),h.push(l),this.h+=1,this};function Wl(a,l){Mt(a),l=Mn(a,l),a.g.has(l)&&(a.i=null,a.h-=a.g.get(l).length,a.g.delete(l))}function Kl(a,l){return Mt(a),l=Mn(a,l),a.g.has(l)}n.forEach=function(a,l){Mt(this),this.g.forEach(function(h,p){h.forEach(function(T){a.call(l,T,p,this)},this)},this)},n.na=function(){Mt(this);const a=Array.from(this.g.values()),l=Array.from(this.g.keys()),h=[];for(let p=0;p<l.length;p++){const T=a[p];for(let D=0;D<T.length;D++)h.push(l[p])}return h},n.V=function(a){Mt(this);let l=[];if(typeof a=="string")Kl(this,a)&&(l=l.concat(this.g.get(Mn(this,a))));else{a=Array.from(this.g.values());for(let h=0;h<a.length;h++)l=l.concat(a[h])}return l},n.set=function(a,l){return Mt(this),this.i=null,a=Mn(this,a),Kl(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[l]),this.h+=1,this},n.get=function(a,l){return a?(a=this.V(a),0<a.length?String(a[0]):l):l};function Ql(a,l,h){Wl(a,l),0<h.length&&(a.i=null,a.g.set(Mn(a,l),k(h)),a.h+=h.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],l=Array.from(this.g.keys());for(var h=0;h<l.length;h++){var p=l[h];const D=encodeURIComponent(String(p)),V=this.V(p);for(p=0;p<V.length;p++){var T=D;V[p]!==""&&(T+="="+encodeURIComponent(String(V[p]))),a.push(T)}}return this.i=a.join("&")};function Mn(a,l){return l=String(l),a.j&&(l=l.toLowerCase()),l}function Xm(a,l){l&&!a.j&&(Mt(a),a.i=null,a.g.forEach(function(h,p){var T=p.toLowerCase();p!=T&&(Wl(this,p),Ql(this,T,h))},a)),a.j=l}function Zm(a,l){const h=new Mo;if(c.Image){const p=new Image;p.onload=S(Ot,h,"TestLoadImage: loaded",!0,l,p),p.onerror=S(Ot,h,"TestLoadImage: error",!1,l,p),p.onabort=S(Ot,h,"TestLoadImage: abort",!1,l,p),p.ontimeout=S(Ot,h,"TestLoadImage: timeout",!1,l,p),c.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=a}else l(!1)}function ew(a,l){const h=new Mo,p=new AbortController,T=setTimeout(()=>{p.abort(),Ot(h,"TestPingServer: timeout",!1,l)},1e4);fetch(a,{signal:p.signal}).then(D=>{clearTimeout(T),D.ok?Ot(h,"TestPingServer: ok",!0,l):Ot(h,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(T),Ot(h,"TestPingServer: error",!1,l)})}function Ot(a,l,h,p,T){try{T&&(T.onload=null,T.onerror=null,T.onabort=null,T.ontimeout=null),p(h)}catch{}}function tw(){this.g=new xm}function nw(a,l,h){const p=h||"";try{zl(a,function(T,D){let V=T;d(T)&&(V=Rs(T)),l.push(p+D+"="+encodeURIComponent(V))})}catch(T){throw l.push(p+"type="+encodeURIComponent("_badmap")),T}}function Fr(a){this.l=a.Ub||null,this.j=a.eb||!1}C(Fr,Ns),Fr.prototype.g=function(){return new $r(this.l,this.j)},Fr.prototype.i=function(a){return function(){return a}}({});function $r(a,l){ke.call(this),this.D=a,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}C($r,ke),n=$r.prototype,n.open=function(a,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=l,this.readyState=1,Lo(this)},n.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const l={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(l.body=a),(this.D||c).fetch(new Request(this.A,l)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Uo(this)),this.readyState=0},n.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Lo(this)),this.g&&(this.readyState=3,Lo(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Yl(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function Yl(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}n.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var l=a.value?a.value:new Uint8Array(0);(l=this.v.decode(l,{stream:!a.done}))&&(this.response=this.responseText+=l)}a.done?Uo(this):Lo(this),this.readyState==3&&Yl(this)}},n.Ra=function(a){this.g&&(this.response=this.responseText=a,Uo(this))},n.Qa=function(a){this.g&&(this.response=a,Uo(this))},n.ga=function(){this.g&&Uo(this)};function Uo(a){a.readyState=4,a.l=null,a.j=null,a.v=null,Lo(a)}n.setRequestHeader=function(a,l){this.u.append(a,l)},n.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],l=this.h.entries();for(var h=l.next();!h.done;)h=h.value,a.push(h[0]+": "+h[1]),h=l.next();return a.join(`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ir=-1;function oE(n,e){const t=n.toTimestamp().seconds,o=n.toTimestamp().nanoseconds+1,r=q.fromTimestamp(o===1e9?new oe(t+1,0):new oe(t,o));return new Ht(r,F.empty(),e)}function rE(n){return new Ht(n.readTime,n.key,ir)}class Ht{constructor(e,t,o){this.readTime=e,this.documentKey=t,this.largestBatchId=o}static min(){return new Ht(q.min(),F.empty(),ir)}static max(){return new Ht(q.max(),F.empty(),ir)}}function iE(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=F.comparator(n.documentKey,e.documentKey),t!==0?t:Q(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function po(n){if(n.code!==N.FAILED_PRECONDITION||n.message!==sE)throw n;U("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PE=new le(F.comparator);function Rt(){return PE}const xf=new le(F.comparator);function zo(...n){let e=xf;for(const t of n)e=e.insert(t.key,t);return e}function Uf(n){let e=xf;return n.forEach((t,o)=>e=e.insert(t,o.overlayedDocument)),e}function hn(){return Jo()}function Lf(){return Jo()}function Jo(){return new Sn(n=>n.toString(),(n,e)=>n.isEqual(e))}const kE=new le(F.comparator),ME=new Ee(F.comparator);function Y(...n){let e=ME;for(const t of n)e=e.add(t);return e}const OE=new Ee(Q);function VE(){return OE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lc(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:bi(e)?"-0":e}}function Ff(n){return{integerValue:""+n}}function BE(n,e){return lE(e)?Ff(e):lc(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cb{constructor(){this.overlays=new le(F.comparator),this.qr=new Map}getOverlay(e,t){return M.resolve(this.overlays.get(t))}getOverlays(e,t){const o=hn();return M.forEach(t,r=>this.getOverlay(e,r).next(i=>{i!==null&&o.set(r,i)})).next(()=>o)}saveOverlays(e,t,o){return o.forEach((r,i)=>{this.St(e,t,i)}),M.resolve()}removeOverlaysForBatchId(e,t,o){const r=this.qr.get(o);return r!==void 0&&(r.forEach(i=>this.overlays=this.overlays.remove(i)),this.qr.delete(o)),M.resolve()}getOverlaysForCollection(e,t,o){const r=hn(),i=t.length+1,s=new F(t.child("")),c=this.overlays.getIteratorFrom(s);for(;c.hasNext();){const u=c.getNext().value,d=u.getKey();if(!t.isPrefixOf(d.path))break;d.path.length===i&&u.largestBatchId>o&&r.set(u.getKey(),u)}return M.resolve(r)}getOverlaysForCollectionGroup(e,t,o,r){let i=new le((d,f)=>d-f);const s=this.overlays.getIterator();for(;s.hasNext();){const d=s.getNext().value;if(d.getKey().getCollectionGroup()===t&&d.largestBatchId>o){let f=i.get(d.largestBatchId);f===null&&(f=hn(),i=i.insert(d.largestBatchId,f)),f.set(d.getKey(),d)}}const c=hn(),u=i.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach((d,f)=>c.set(d,f)),!(c.size()>=r)););return M.resolve(c)}St(e,t,o){const r=this.overlays.get(o.key);if(r!==null){const s=this.qr.get(r.largestBatchId).delete(o.key);this.qr.set(r.largestBatchId,s)}this.overlays=this.overlays.insert(o.key,new jE(t,o));let i=this.qr.get(t);i===void 0&&(i=Y(),this.qr.set(t,i)),this.qr.set(t,i.add(o.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rb{constructor(){this.sessionToken=Se.EMPTY_BYTE_STRING}getSessionToken(e){return M.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,M.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rg{constructor(e,t){this.ui={},this.overlays={},this.ci=new Hi(0),this.li=!1,this.li=!0,this.hi=new Rb,this.referenceDelegate=e(this),this.Pi=new Mb(this),this.indexManager=new wb,this.remoteDocumentCache=function(r){return new Pb(r)}(o=>this.referenceDelegate.Ti(o)),this.serializer=new pb(t),this.Ii=new Db(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.li=!1,Promise.resolve()}get started(){return this.li}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new Cb,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let o=this.ui[e.toKey()];return o||(o=new Nb(t,this.referenceDelegate),this.ui[e.toKey()]=o),o}getGlobalsCache(){return this.hi}getTargetCache(){return this.Pi}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ii}runTransaction(e,t,o){U("MemoryPersistence","Starting transaction:",e);const r=new Ob(this.ci.next());return this.referenceDelegate.Ei(),o(r).next(i=>this.referenceDelegate.di(r).next(()=>i)).toPromise().then(i=>(r.raiseOnCommittedEvent(),i))}Ai(e,t){return M.or(Object.values(this.ui).map(o=>()=>o.containsKey(e,t)))}}class Ob extends aE{constructor(e){super(),this.currentSequenceNumber=e}}class pc{constructor(e){this.persistence=e,this.Ri=new gc,this.Vi=null}static mi(e){return new pc(e)}get fi(){if(this.Vi)return this.Vi;throw G(60996)}addReference(e,t,o){return this.Ri.addReference(o,t),this.fi.delete(o.toString()),M.resolve()}removeReference(e,t,o){return this.Ri.removeReference(o,t),this.fi.add(o.toString()),M.resolve()}markPotentiallyOrphaned(e,t){return this.fi.add(t.toString()),M.resolve()}removeTarget(e,t){this.Ri.jr(t.targetId).forEach(r=>this.fi.add(r.toString()));const o=this.persistence.getTargetCache();return o.getMatchingKeysForTargetId(e,t.targetId).next(r=>{r.forEach(i=>this.fi.add(i.toString()))}).next(()=>o.removeTargetData(e,t))}Ei(){this.Vi=new Set}di(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return M.forEach(this.fi,o=>{const r=F.fromPath(o);return this.gi(e,r).next(i=>{i||t.removeEntry(r,q.min())})}).next(()=>(this.Vi=null,t.apply(e)))}updateLimboDocument(e,t){return this.gi(e,t).next(o=>{o?this.fi.delete(t.toString()):this.fi.add(t.toString())})}Ti(e){return 0}gi(e,t){return M.or([()=>M.resolve(this.Ri.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ai(e,t)])}}class Ci{constructor(e,t){this.persistence=e,this.pi=new Sn(o=>uE(o.path),(o,r)=>o.isEqual(r)),this.garbageCollector=Tb(this,t)}static mi(e,t){return new Ci(e,t)}Ei(){}di(e){return M.resolve()}forEachTarget(e,t){return this.persistence.getTargetCache().forEachTarget(e,t)}gr(e){const t=this.wr(e);return this.persistence.getTargetCache().getTargetCount(e).next(o=>t.next(r=>o+r))}wr(e){let t=0;return this.pr(e,o=>{t++}).next(()=>t)}pr(e,t){return M.forEach(this.pi,(o,r)=>this.br(e,o,r).next(i=>i?M.resolve():t(r)))}removeTargets(e,t,o){return this.persistence.getTargetCache().removeTargets(e,t,o)}removeOrphanedDocuments(e,t){let o=0;const r=this.persistence.getRemoteDocumentCache(),i=r.newChangeBuffer();return r.ii(e,s=>this.br(e,s,t).next(c=>{c||(o++,i.removeEntry(s,q.min()))})).next(()=>i.apply(e)).next(()=>o)}markPotentiallyOrphaned(e,t){return this.pi.set(t,e.currentSequenceNumber),M.resolve()}removeTarget(e,t){const o=t.withSequenceNumber(e.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(e,o)}addReference(e,t,o){return this.pi.set(o,e.currentSequenceNumber),M.resolve()}removeReference(e,t,o){return this.pi.set(o,e.currentSequenceNumber),M.resolve()}updateLimboDocument(e,t){return this.pi.set(t,e.currentSequenceNumber),M.resolve()}Ti(e){let t=e.key.toString().length;return e.isFoundDocument()&&(t+=li(e.data.value)),t}br(e,t,o){return M.or([()=>this.persistence.Ai(e,t),()=>this.persistence.getTargetCache().containsKey(e,t),()=>{const r=this.pi.get(t);return M.resolve(r!==void 0&&r>o)}])}getCacheSize(e){return this.persistence.getRemoteDocumentCache().getSize(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bb{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=function(){return Dw()?8:cE(Le())>0?6:4}()}initialize(e,t){this.ps=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,o,r){const i={result:null};return this.ys(e,t).next(s=>{i.result=s}).next(()=>{if(!i.result)return this.ws(e,t,r,o).next(s=>{i.result=s})}).next(()=>{if(i.result)return;const s=new Vb;return this.Ss(e,t,s).next(c=>{if(i.result=c,this.Vs)return this.bs(e,t,s,c.size)})}).next(()=>i.result)}bs(e,t,o,r){return o.documentReadCount<this.fs?(Bn()<=K.DEBUG&&U("QueryEngine","SDK will not create cache indexes for query:",xn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),M.resolve()):(Bn()<=K.DEBUG&&U("QueryEngine","Query:",xn(t),"scans",o.documentReadCount,"local documents and returns",r,"documents as results."),o.documentReadCount>this.gs*r?(Bn()<=K.DEBUG&&U("QueryEngine","The SDK decides to create cache indexes for query:",xn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,dt(t))):M.resolve())}ys(e,t){if(fd(t))return M.resolve(null);let o=dt(t);return this.indexManager.getIndexType(e,o).next(r=>r===0?null:(t.limit!==null&&r===1&&(t=Aa(t,null,"F"),o=dt(t)),this.indexManager.getDocumentsMatchingTarget(e,o).next(i=>{const s=Y(...i);return this.ps.getDocuments(e,s).next(c=>this.indexManager.getMinOffset(e,o).next(u=>{const d=this.Ds(t,c);return this.Cs(t,d,s,u.readTime)?this.ys(e,Aa(t,null,"F")):this.vs(e,d,t,u)}))})))}ws(e,t,o,r){return fd(t)||r.isEqual(q.min())?M.resolve(null):this.ps.getDocuments(e,o).next(i=>{const s=this.Ds(t,i);return this.Cs(t,s,o,r)?M.resolve(null):(Bn()<=K.DEBUG&&U("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),xn(t)),this.vs(e,s,t,oE(r,ir)).next(c=>c))})}Ds(e,t){let o=new Ee(Bf(e));return t.forEach((r,i)=>{Ji(e,i)&&(o=o.add(i))}),o}Cs(e,t,o,r){if(e.limit===null)return!1;if(o.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Ss(e,t,o){return Bn()<=K.DEBUG&&U("QueryEngine","Using full collection scan to execute query:",xn(t)),this.ps.getDocumentsMatchingQuery(e,t,Ht.min(),o)}vs(e,t,o,r){return this.ps.getDocumentsMatchingQuery(e,o,r).next(i=>(t.forEach(s=>{i=i.insert(s.key,s)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve="WebChannelConnection";class Jb extends Qb{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,o,r,i){const s=ka();return new Promise((c,u)=>{const d=new af;d.setWithCredentials(!0),d.listenOnce(cf.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case ci.NO_ERROR:const g=d.getResponseJson();U(Ve,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(g)),c(g);break;case ci.TIMEOUT:U(Ve,`RPC '${e}' ${s} timed out`),u(new x(N.DEADLINE_EXCEEDED,"Request time out"));break;case ci.HTTP_ERROR:const m=d.getStatus();if(U(Ve,`RPC '${e}' ${s} failed with status:`,m,"response text:",d.getResponseText()),m>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const C=S?.error;if(C&&C.status&&C.message){const k=function(L){const $=L.toLowerCase().replace(/_/g,"-");return Object.values(N).indexOf($)>=0?$:N.UNKNOWN}(C.status);u(new x(k,C.message))}else u(new x(N.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new x(N.UNAVAILABLE,"Connection failed."));break;default:G(9055,{l_:e,streamId:s,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{U(Ve,`RPC '${e}' ${s} completed.`)}});const f=JSON.stringify(r);U(Ve,`RPC '${e}' ${s} sending request:`,r),d.send(t,"POST",f,o,15)})}T_(e,t,o){const r=ka(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],s=df(),c=uf(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,t,o),u.encodeInitMessageHeaders=!0;const f=i.join("");U(Ve,`Creating RPC '${e}' stream ${r}: ${f}`,u);const g=s.createWebChannel(f,u);this.I_(g);let m=!1,S=!1;const C=new Yb({Yo:P=>{S?U(Ve,`Not sending because RPC '${e}' stream ${r} is closed:`,P):(m||(U(Ve,`Opening RPC '${e}' stream ${r} transport.`),g.open(),m=!0),U(Ve,`RPC '${e}' stream ${r} sending:`,P),g.send(P))},Zo:()=>g.close()}),k=(P,L,$)=>{P.listen(L,W=>{try{$(W)}catch(ue){setTimeout(()=>{throw ue},0)}})};return k(g,Go.EventType.OPEN,()=>{S||(U(Ve,`RPC '${e}' stream ${r} transport opened.`),C.o_())}),k(g,Go.EventType.CLOSE,()=>{S||(S=!0,U(Ve,`RPC '${e}' stream ${r} transport closed`),C.a_(),this.E_(g))}),k(g,Go.EventType.ERROR,P=>{S||(S=!0,_n(Ve,`RPC '${e}' stream ${r} transport errored. Name:`,P.name,"Message:",P.message),C.a_(new x(N.UNAVAILABLE,"The operation could not be completed")))}),k(g,Go.EventType.MESSAGE,P=>{if(!S){const L=P.data[0];te(!!L,16349);const $=L,W=$?.error||$[0]?.error;if(W){U(Ve,`RPC '${e}' stream ${r} received error:`,W);const ue=W.status;let Ne=function(w){const _=we[w];if(_!==void 0)return Wf(_)}(ue),ie=W.message;Ne===void 0&&(Ne=N.INTERNAL,ie="Unknown error status: "+ue+" with message "+W.message),S=!0,C.a_(new x(Ne,ie)),g.close()}else U(Ve,`RPC '${e}' stream ${r} received:`,L),C.u_(L)}}),k(c,lf.STAT_EVENT,P=>{P.stat===_a.PROXY?U(Ve,`RPC '${e}' stream ${r} detected buffering proxy`):P.stat===_a.NOPROXY&&U(Ve,`RPC '${e}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{C.__()},0),C}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(t=>t===e)}}function ta(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pg{constructor(e){this.key=e}}class mg{constructor(e){this.key=e}}class _T{constructor(e,t){this.query=e,this.Ya=t,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=Y(),this.mutatedKeys=Y(),this.eu=Bf(e),this.tu=new qn(this.eu)}get nu(){return this.Ya}ru(e,t){const o=t?t.iu:new kd,r=t?t.tu:this.tu;let i=t?t.mutatedKeys:this.mutatedKeys,s=r,c=!1;const u=this.query.limitType==="F"&&r.size===this.query.limit?r.last():null,d=this.query.limitType==="L"&&r.size===this.query.limit?r.first():null;if(e.inorderTraversal((f,g)=>{const m=r.get(f),S=Ji(this.query,g)?g:null,C=!!m&&this.mutatedKeys.has(m.key),k=!!S&&(S.hasLocalMutations||this.mutatedKeys.has(S.key)&&S.hasCommittedMutations);let P=!1;m&&S?m.data.isEqual(S.data)?C!==k&&(o.track({type:3,doc:S}),P=!0):this.su(m,S)||(o.track({type:2,doc:S}),P=!0,(u&&this.eu(S,u)>0||d&&this.eu(S,d)<0)&&(c=!0)):!m&&S?(o.track({type:0,doc:S}),P=!0):m&&!S&&(o.track({type:1,doc:m}),P=!0,(u||d)&&(c=!0)),P&&(S?(s=s.add(S),i=k?i.add(f):i.delete(f)):(s=s.delete(f),i=i.delete(f)))}),this.query.limit!==null)for(;s.size>this.query.limit;){const f=this.query.limitType==="F"?s.last():s.first();s=s.delete(f.key),i=i.delete(f.key),o.track({type:1,doc:f})}return{tu:s,iu:o,Cs:c,mutatedKeys:i}}su(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,o,r){const i=this.tu;this.tu=e.tu,this.mutatedKeys=e.mutatedKeys;const s=e.iu.ya();s.sort((f,g)=>function(S,C){const k=P=>{switch(P){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return G(20277,{Rt:P})}};return k(S)-k(C)}(f.type,g.type)||this.eu(f.doc,g.doc)),this.ou(o),r=r??!1;const c=t&&!r?this._u():[],u=this.Xa.size===0&&this.current&&!r?1:0,d=u!==this.Za;return this.Za=u,s.length!==0||d?{snapshot:new no(this.query,e.tu,i,s,e.mutatedKeys,u===0,d,!1,!!o&&o.resumeToken.approximateByteSize()>0),au:c}:{au:c}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new kd,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(e){return!this.Ya.has(e)&&!!this.tu.has(e)&&!this.tu.get(e).hasLocalMutations}ou(e){e&&(e.addedDocuments.forEach(t=>this.Ya=this.Ya.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ya=this.Ya.delete(t)),this.current=e.current)}_u(){if(!this.current)return[];const e=this.Xa;this.Xa=Y(),this.tu.forEach(o=>{this.uu(o.key)&&(this.Xa=this.Xa.add(o.key))});const t=[];return e.forEach(o=>{this.Xa.has(o)||t.push(new mg(o))}),this.Xa.forEach(o=>{e.has(o)||t.push(new pg(o))}),t}cu(e){this.Ya=e.Qs,this.Xa=Y();const t=this.ru(e.documents);return this.applyChanges(t,!0)}lu(){return no.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const Cc="SyncEngine";class vT{constructor(e,t,o){this.query=e,this.targetId=t,this.view=o}}class ET{constructor(e){this.key=e,this.hu=!1}}class bT{constructor(e,t,o,r,i,s){this.localStore=e,this.remoteStore=t,this.eventManager=o,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=s,this.Pu={},this.Tu=new Sn(c=>Vf(c),Yi),this.Iu=new Map,this.Eu=new Set,this.du=new le(F.comparator),this.Au=new Map,this.Ru=new gc,this.Vu={},this.mu=new Map,this.fu=to.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function TT(n,e,t=!0){const o=bg(n);let r;const i=o.Tu.get(e);return i?(o.sharedClientState.addLocalQueryTarget(i.targetId),r=i.view.lu()):r=await wg(o,e,t,!0),r}async function IT(n,e){const t=bg(n);await wg(t,e,!0,!1)}async function wg(n,e,t,o){const r=await qb(n.localStore,dt(e)),i=r.targetId,s=n.sharedClientState.addLocalQueryTarget(i,t);let c;return o&&(c=await ST(n,e,i,s==="current",r.resumeToken)),n.isPrimaryClient&&t&&lg(n.remoteStore,r),c}async function ST(n,e,t,o,r){n.pu=(g,m,S)=>async function(k,P,L,$){let W=P.view.ru(L);W.Cs&&(W=await Ad(k.localStore,P.query,!1).then(({documents:b})=>P.view.ru(b,W)));const ue=$&&$.targetChanges.get(P.targetId),Ne=$&&$.targetMismatches.get(P.targetId)!=null,ie=P.view.applyChanges(W,k.isPrimaryClient,ue,Ne);return Bd(k,P.targetId,ie.au),ie.snapshot}(n,g,m,S);const i=await Ad(n.localStore,e,!0),s=new _T(e,i.Qs),c=s.ru(i.documents),u=wr.createSynthesizedTargetChangeForCurrentChange(t,o&&n.onlineState!=="Offline",r),d=s.applyChanges(c,n.isPrimaryClient,u);Bd(n,t,d.au);const f=new vT(e,t,s);return n.Tu.set(e,f),n.Iu.has(t)?n.Iu.get(t).push(e):n.Iu.set(t,[e]),d.snapshot}async function AT(n,e,t){const o=H(n),r=o.Tu.get(e),i=o.Iu.get(r.targetId);if(i.length>1)return o.Iu.set(r.targetId,i.filter(s=>!Yi(s,e))),void o.Tu.delete(e);o.isPrimaryClient?(o.sharedClientState.removeLocalQueryTarget(r.targetId),o.sharedClientState.isActiveQueryTarget(r.targetId)||await Pa(o.localStore,r.targetId,!1).then(()=>{o.sharedClientState.clearQueryState(r.targetId),t&&yc(o.remoteStore,r.targetId),Oa(o,r.targetId)}).catch(po)):(Oa(o,r.targetId),await Pa(o.localStore,r.targetId,!0))}async function DT(n,e){const t=H(n),o=t.Tu.get(e),r=t.Iu.get(o.targetId);t.isPrimaryClient&&r.length===1&&(t.sharedClientState.removeLocalQueryTarget(o.targetId),yc(t.remoteStore,o.targetId))}async function CT(n,e,t){const o=VT(n);try{const r=await function(s,c){const u=H(s),d=oe.now(),f=c.reduce((S,C)=>S.add(C.key),Y());let g,m;return u.persistence.runTransaction("Locally write mutations","readwrite",S=>{let C=Rt(),k=Y();return u.Ns.getEntries(S,f).next(P=>{C=P,C.forEach((L,$)=>{$.isValidDocument()||(k=k.add(L))})}).next(()=>u.localDocuments.getOverlayedDocuments(S,C)).next(P=>{g=P;const L=[];for(const $ of c){const W=GE($,g.get($.key).overlayedDocument);W!=null&&L.push(new Zt($.key,W,Df(W.value.mapValue),Ge.exists(!0)))}return u.mutationQueue.addMutationBatch(S,d,L,c)}).next(P=>{m=P;const L=P.applyToLocalDocumentSet(g,k);return u.documentOverlayCache.saveOverlays(S,P.batchId,L)})}).then(()=>({batchId:m.batchId,changes:Uf(g)}))}(o.localStore,e);o.sharedClientState.addPendingMutation(r.batchId),function(s,c,u){let d=s.Vu[s.currentUser.toKey()];d||(d=new le(Q)),d=d.insert(c,u),s.Vu[s.currentUser.toKey()]=d}(o,r.batchId,t),await _r(o,r.changes),await rs(o.remoteStore)}catch(r){const i=Tc(r,"Failed to persist write");t.reject(i)}}async function yg(n,e){const t=H(n);try{const o=await $b(t.localStore,e);e.targetChanges.forEach((r,i)=>{const s=t.Au.get(i);s&&(te(r.addedDocuments.size+r.modifiedDocuments.size+r.removedDocuments.size<=1,22616),r.addedDocuments.size>0?s.hu=!0:r.modifiedDocuments.size>0?te(s.hu,14607):r.removedDocuments.size>0&&(te(s.hu,42227),s.hu=!1))}),await _r(t,o,e)}catch(o){await po(o)}}function Vd(n,e,t){const o=H(n);if(o.isPrimaryClient&&t===0||!o.isPrimaryClient&&t===1){const r=[];o.Tu.forEach((i,s)=>{const c=s.view.va(e);c.snapshot&&r.push(c.snapshot)}),function(s,c){const u=H(s);u.onlineState=c;let d=!1;u.queries.forEach((f,g)=>{for(const m of g.Sa)m.va(c)&&(d=!0)}),d&&Ac(u)}(o.eventManager,e),r.length&&o.Pu.H_(r),o.onlineState=e,o.isPrimaryClient&&o.sharedClientState.setOnlineState(e)}}async function RT(n,e,t){const o=H(n);o.sharedClientState.updateQueryState(e,"rejected",t);const r=o.Au.get(e),i=r&&r.key;if(i){let s=new le(F.comparator);s=s.insert(i,xe.newNoDocument(i,q.min()));const c=Y().add(i),u=new ts(q.min(),new Map,new le(Q),s,c);await yg(o,u),o.du=o.du.remove(i),o.Au.delete(e),Rc(o)}else await Pa(o.localStore,e,!1).then(()=>Oa(o,e,t)).catch(po)}async function NT(n,e){const t=H(n),o=e.batch.batchId;try{const r=await Fb(t.localStore,e);vg(t,o,null),_g(t,o),t.sharedClientState.updateMutationState(o,"acknowledged"),await _r(t,r)}catch(r){await po(r)}}async function PT(n,e,t){const o=H(n);try{const r=await function(s,c){const u=H(s);return u.persistence.runTransaction("Reject batch","readwrite-primary",d=>{let f;return u.mutationQueue.lookupMutationBatch(d,c).next(g=>(te(g!==null,37113),f=g.keys(),u.mutationQueue.removeMutationBatch(d,g))).next(()=>u.mutationQueue.performConsistencyCheck(d)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(d,f,c)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,f)).next(()=>u.localDocuments.getDocuments(d,f))})}(o.localStore,e);vg(o,e,t),_g(o,e),o.sharedClientState.updateMutationState(e,"rejected",t),await _r(o,r)}catch(r){await po(r)}}function _g(n,e){(n.mu.get(e)||[]).forEach(t=>{t.resolve()}),n.mu.delete(e)}function vg(n,e,t){const o=H(n);let r=o.Vu[o.currentUser.toKey()];if(r){const i=r.get(e);i&&(t?i.reject(t):i.resolve(),r=r.remove(e)),o.Vu[o.currentUser.toKey()]=r}}function Oa(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const o of n.Iu.get(e))n.Tu.delete(o),t&&n.Pu.yu(o,t);n.Iu.delete(e),n.isPrimaryClient&&n.Ru.jr(e).forEach(o=>{n.Ru.containsKey(o)||Eg(n,o)})}function Eg(n,e){n.Eu.delete(e.path.canonicalString());const t=n.du.get(e);t!==null&&(yc(n.remoteStore,t),n.du=n.du.remove(e),n.Au.delete(t),Rc(n))}function Bd(n,e,t){for(const o of t)o instanceof pg?(n.Ru.addReference(o.key,e),kT(n,o)):o instanceof mg?(U(Cc,"Document no longer in limbo: "+o.key),n.Ru.removeReference(o.key,e),n.Ru.containsKey(o.key)||Eg(n,o.key)):G(19791,{wu:o})}function kT(n,e){const t=e.key,o=t.path.canonicalString();n.du.get(t)||n.Eu.has(o)||(U(Cc,"New document in limbo: "+t),n.Eu.add(o),Rc(n))}function Rc(n){for(;n.Eu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const e=n.Eu.values().next().value;n.Eu.delete(e);const t=new F(re.fromString(e)),o=n.fu.next();n.Au.set(o,new ET(t)),n.du=n.du.insert(t,o),lg(n.remoteStore,new Ft(dt(Qi(t.path)),o,"TargetPurposeLimboResolution",Hi.ce))}}async function _r(n,e,t){const o=H(n),r=[],i=[],s=[];o.Tu.isEmpty()||(o.Tu.forEach((c,u)=>{s.push(o.pu(u,e,t).then(d=>{if((d||t)&&o.isPrimaryClient){const f=d?!d.fromCache:t?.targetChanges.get(u.targetId)?.current;o.sharedClientState.updateQueryState(u.targetId,f?"current":"not-current")}if(d){r.push(d);const f=mc.As(u.targetId,d);i.push(f)}}))}),await Promise.all(s),o.Pu.H_(r),await async function(u,d){const f=H(u);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",g=>M.forEach(d,m=>M.forEach(m.Es,S=>f.persistence.referenceDelegate.addReference(g,m.targetId,S)).next(()=>M.forEach(m.ds,S=>f.persistence.referenceDelegate.removeReference(g,m.targetId,S)))))}catch(g){if(!mo(g))throw g;U(wc,"Failed to update sequence numbers: "+g)}for(const g of d){const m=g.targetId;if(!g.fromCache){const S=f.Ms.get(m),C=S.snapshotVersion,k=S.withLastLimboFreeSnapshotVersion(C);f.Ms=f.Ms.insert(m,k)}}}(o.localStore,i))}async function MT(n,e){const t=H(n);if(!t.currentUser.isEqual(e)){U(Cc,"User change. New user:",e.toKey());const o=await ig(t.localStore,e);t.currentUser=e,function(i,s){i.mu.forEach(c=>{c.forEach(u=>{u.reject(new x(N.CANCELLED,s))})}),i.mu.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,o.removedBatchIds,o.addedBatchIds),await _r(t,o.Ls)}}function OT(n,e){const t=H(n),o=t.Au.get(e);if(o&&o.hu)return Y().add(o.key);{let r=Y();const i=t.Iu.get(e);if(!i)return r;for(const s of i){const c=t.Tu.get(s);r=r.unionWith(c.view.nu)}return r}}function bg(n){const e=H(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=yg.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=OT.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=RT.bind(null,e),e.Pu.H_=wT.bind(null,e.eventManager),e.Pu.yu=yT.bind(null,e.eventManager),e}function VT(n){const e=H(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=NT.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=PT.bind(null,e),e}class Ni{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=ns(e.databaseInfo.databaseId),this.sharedClientState=this.Du(e),this.persistence=this.Cu(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Fu(e,this.localStore),this.indexBackfillerScheduler=this.Mu(e,this.localStore)}Fu(e,t){return null}Mu(e,t){return null}vu(e){return Lb(this.persistence,new Bb,e.initialUser,this.serializer)}Cu(e){return new rg(pc.mi,this.serializer)}Du(e){return new Hb}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Ni.provider={build:()=>new Ni};class BT extends Ni{constructor(e){super(),this.cacheSizeBytes=e}Fu(e,t){te(this.persistence.referenceDelegate instanceof Ci,46915);const o=this.persistence.referenceDelegate.garbageCollector;return new Eb(o,e.asyncQueue,t)}Cu(e){const t=this.cacheSizeBytes!==void 0?ze.withCacheSize(this.cacheSizeBytes):ze.DEFAULT;return new rg(o=>Ci.mi(o,t),this.serializer)}}class Va{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=o=>Vd(this.syncEngine,o,1),this.remoteStore.remoteSyncer.handleCredentialChange=MT.bind(null,this.syncEngine),await gT(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new mT}()}createDatastore(e){const t=ns(e.databaseInfo.databaseId),o=function(i){return new Jb(i)}(e.databaseInfo);return function(i,s,c,u){return new tT(i,s,c,u)}(e.authCredentials,e.appCheckCredentials,o,t)}createRemoteStore(e){return function(o,r,i,s,c){return new oT(o,r,i,s,c)}(this.localStore,this.datastore,e.asyncQueue,t=>Vd(this.syncEngine,t,0),function(){return Rd.v()?new Rd:new Wb}())}createSyncEngine(e,t){return function(r,i,s,c,u,d,f){const g=new bT(r,i,s,c,u,d);return f&&(g.gu=!0),g}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){await async function(t){const o=H(t);U(vn,"RemoteStore shutting down."),o.Ea.add(5),await yr(o),o.Aa.shutdown(),o.Ra.set("Unknown")}(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}Va.provider={build:()=>new Va};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sg="firestore.googleapis.com",Ld=!0;class Fd{constructor(e){if(e.host===void 0){if(e.ssl!==void 0)throw new x(N.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=Sg,this.ssl=Ld}else this.host=e.host,this.ssl=e.ssl??Ld;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=og;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<_b)throw new x(N.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}mf("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=Ig(e.experimentalLongPollingOptions??{}),function(o){if(o.timeoutSeconds!==void 0){if(isNaN(o.timeoutSeconds))throw new x(N.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (must not be NaN)`);if(o.timeoutSeconds<5)throw new x(N.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (minimum allowed value is 5)`);if(o.timeoutSeconds>30)throw new x(N.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(o,r){return o.timeoutSeconds===r.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class is{constructor(e,t,o,r){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=o,this._app=r,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Fd({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new x(N.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new x(N.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Fd(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=function(o){if(!o)return new gf;switch(o.type){case"firstParty":return new Jv(o.sessionIndex||"0",o.iamToken||null,o.authTokenFactory||null);case"provider":return o.client;default:throw new x(N.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(t){const o=Ud.get(t);o&&(U("ComponentProvider","Removing Datastore"),Ud.delete(t),o.terminate())}(this),Promise.resolve()}}function Ag(n,e,t,o={}){n=Ue(n,is);const r=uo(e),i=n._getSettings(),s={...i,emulatorOptions:n._getEmulatorOptions()},c=`${e}:${t}`;r&&(wh(`https://${c}`),yh("Firestore",!0)),i.host!==Sg&&i.host!==c&&_n("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");const u={...i,host:c,ssl:r,emulatorOptions:o};if(!ft(u,s)&&(n._setSettings(u),o.mockUserToken)){let d,f;if(typeof o.mockUserToken=="string")d=o.mockUserToken,f=Be.MOCK_USER;else{d=_w(o.mockUserToken,n._app?.options.projectId);const g=o.mockUserToken.sub||o.mockUserToken.user_id;if(!g)throw new x(N.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");f=new Be(g)}n._authCredentials=new Kv(new ff(d,f))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ir(n){return _o(n=Ue(n,st)),new Gg(n,e=>bo(n,e))}(function(e,t=!0){(function(r){go=r})(ho),gt(new rt("firestore",(o,{instanceIdentifier:r,options:i})=>{const s=o.getProvider("app").getImmediate(),c=new st(new Qv(o.getProvider("auth-internal")),new Xv(s,o.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new x(N.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Yn(d.options.projectId,f)}(s,r),s);return i={useFetchStreams:t,...i},c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),Je(Ku,Qu,e),Je(Ku,Qu,"esm2020")})();const Ye=Object.freeze(Object.defineProperty({__proto__:null,AbstractUserDataWriter:Fg,Bytes:We,CollectionReference:St,DocumentReference:ae,DocumentSnapshot:qt,FieldPath:vo,FieldValue:Dn,Firestore:st,FirestoreError:x,GeoPoint:nt,Query:Nt,QueryCompositeFilterConstraint:ls,QueryConstraint:Uc,QueryDocumentSnapshot:Zo,QueryFieldFilterConstraint:Er,QueryOrderByConstraint:us,QuerySnapshot:jt,SnapshotMetadata:Fn,Timestamp:oe,VectorValue:ot,WriteBatch:Gg,_AutoId:qi,_ByteString:Se,_DatabaseId:Yn,_DocumentKey:F,_EmptyAuthCredentialsProvider:gf,_FieldPath:Ie,_cast:Ue,_logWarn:_n,_validateIsNotUsedTogether:mf,addDoc:tn,arrayRemove:XT,arrayUnion:JT,collection:me,connectFirestoreEmulator:Ag,deleteDoc:Eo,doc:fe,ensureFirestoreConfigured:_o,executeWrite:bo,getDoc:br,getDocs:wt,getFirestore:Dg,onSnapshot:Tr,orderBy:Ug,query:Re,serverTimestamp:ds,setDoc:YT,updateDoc:en,where:Ae,writeBatch:Ir},Symbol.toStringTag,{value:"Module"})),zg="@firebase/installations",$c="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qg=1e4,jg=`w:${$c}`,Hg="FIS_v2",ZT="https://firebaseinstallations.googleapis.com/v1",eI=3600*1e3,tI="installations",nI="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lI=/^[cdef][\w-]{21}$/,xa="";function uI(){try{const n=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(n),n[0]=112+n[0]%16;const t=dI(n);return lI.test(t)?t:xa}catch{return xa}}function dI(n){return cI(n).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function NI(n){const e=n,{installationEntry:t,registrationPromise:o}=await zc(e);return o?o.catch(console.error):qc(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function PI(n,e=!1){const t=n;return await kI(t),(await qc(t,e)).token}async function kI(n){const{registrationPromise:e}=await zc(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MI(n){if(!n||!n.options)throw ia("App Configuration");if(!n.name)throw ia("App Name");const e=["projectId","apiKey","appId"];for(const t of e)if(!n.options[t])throw ia(t);return{appName:n.name,projectId:n.options.projectId,apiKey:n.options.apiKey,appId:n.options.appId}}function ia(n){return En.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sp="installations",OI="installations-internal",VI=n=>{const e=n.getProvider("app").getImmediate(),t=MI(e),o=In(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:o,_delete:()=>Promise.resolve()}},BI=n=>{const e=n.getProvider("app").getImmediate(),t=In(e,sp).getImmediate();return{getId:()=>NI(t),getToken:r=>PI(t,r)}};function xI(){gt(new rt(sp,VI,"PUBLIC")),gt(new rt(OI,BI,"PRIVATE"))}xI();Je(zg,$c);Je(zg,$c,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oi="analytics",UI="firebase_id",LI="origin",FI=60*1e3,$I="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",jc="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zI(n){if(!n.startsWith(jc)){const e=Qe.create("invalid-gtag-resource",{gtagURL:n});return je.warn(e.message),""}return n}function ap(n){return Promise.all(n.map(e=>e.catch(t=>t)))}function qI(n,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(n,e)),t}function jI(n,e){const t=qI("firebase-js-sdk-policy",{createScriptURL:zI}),o=document.createElement("script"),r=`${jc}?l=${n}&id=${e}`;o.src=t?t?.createScriptURL(r):r,o.async=!0,document.head.appendChild(o)}function HI(n){let e=[];return Array.isArray(window[n])?e=window[n]:window[n]=e,e}async function WI(n,e,t,o,r,i){const s=o[r];try{if(s)await e[s];else{const u=(await ap(t)).find(d=>d.measurementId===r);u&&await e[u.appId]}}catch(c){je.error(c)}n("config",r,i)}async function KI(n,e,t,o,r){try{let i=[];if(r&&r.send_to){let s=r.send_to;Array.isArray(s)||(s=[s]);const c=await ap(t);for(const u of s){const d=c.find(g=>g.measurementId===u),f=d&&e[d.appId];if(f)i.push(f);else{i=[];break}}}i.length===0&&(i=Object.values(e)),await Promise.all(i),n("event",o,r||{})}catch(i){je.error(i)}}function QI(n,e,t,o){async function r(i,...s){try{if(i==="event"){const[c,u]=s;await KI(n,e,t,c,u)}else if(i==="config"){const[c,u]=s;await WI(n,e,t,o,c,u)}else if(i==="consent"){const[c,u]=s;n("consent",c,u)}else if(i==="get"){const[c,u,d]=s;n("get",c,u,d)}else if(i==="set"){const[c]=s;n("set",c)}else n(i,...s)}catch(c){je.error(c)}}return r}function YI(n,e,t,o,r){let i=function(...s){window[o].push(arguments)};return window[r]&&typeof window[r]=="function"&&(i=window[r]),window[r]=QI(i,n,e,t),{gtagCore:i,wrappedGtag:window[r]}}function JI(n){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(jc)&&t.src.includes(n))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`)}
        ...
        `,C.className="perf-modal",C.appendChild(k),document.body.appendChild(C),C.addEventListener("click",P=>{P.target===C&&C.remove()}),O().success(`Mostrando ${m.length} eventos de performance`)}).catch(g=>{console.error("[DEBUG] Erro ao carregar eventos de performance:",g),O().error("Erro ao carregar eventos de performance")});return}if(e.id==="toggle-theme-btn"){const g=document.documentElement.classList.contains("dark");g?(document.documentElement.classList.remove("dark"),localStorage.setItem("theme","light"),e.textContent="🌙 Modo Escuro"):(document.documentElement.classList.add("dark"),localStorage.setItem("theme","dark"),e.textContent="☀️ Modo Claro"),O().success(`Tema alterado para ${g?"claro":"escuro"}`);return}if(e.classList?.contains("color-theme-btn")){const g=e.getAttribute("data-theme");g&&(localStorage.setItem("colorTheme",g),document.body.setAttribute("data-color-theme",g),O().success(`Tema de cor alterado para ${g}`));return}if(e.classList?.contains("compact-size-btn")){const g=e.getAttribute("data-size");g&&(Ho(g),O().success(`Tamanho compacto: ${g}`));return}if(e.id==="check-updates-btn"||e.textContent&&e.textContent.includes("Atualizações")||e.closest("#check-updates-btn")){let L=function(){console.log("🔍 [DEBUG] Fechando modal..."),S&&(S.remove(),console.log("🔍 [DEBUG] Modal removido com sucesso"));const $=document.getElementById("update-modal");$&&($.remove(),console.log("🔍 [DEBUG] Modal órfão removido"))};console.log("🚀 [TESTE DIRETO] Botão de atualizações detectado!"),console.log("🔍 [DEBUG] Elemento clicado:",e),console.log("🔍 [DEBUG] ID do elemento:",e.id),console.log("🔍 [DEBUG] Texto do elemento:",e.textContent),console.log("🔍 [DEBUG] Closest check-updates-btn:",e.closest("#check-updates-btn")),n.preventDefault(),n.stopPropagation();const g=document.getElementById("update-modal");g&&(console.log("🔍 [DEBUG] Removendo modal existente..."),g.remove());const m=`

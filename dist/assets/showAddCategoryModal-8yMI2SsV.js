const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CX4-X0-k.js","assets/main-CNDNG6O2.css","assets/CategoriesPage-9cjV5PEQ.js","assets/PeriodIndicator-SicmHycx.js","assets/UIService-WhvCg0YK.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-CX4-X0-k.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

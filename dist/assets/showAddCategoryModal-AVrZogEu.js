const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-B3h3klJd.js","assets/main-Blqym63I.css","assets/CategoriesPage-CaENkkRJ.js","assets/PeriodIndicator-BnHP3j6O.js","assets/UIService-C-IwalZm.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-B3h3klJd.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CzPCZznX.js","assets/main-B6J4K76K.css","assets/CategoriesPage-CnwnmiEV.js","assets/PeriodIndicator-Bgsrn2dJ.js","assets/UIService-BInk1ZPs.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-CzPCZznX.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-D08vCkb1.js","assets/main-CHJigVyv.css","assets/CategoriesPage-C-1EpvwR.js","assets/PeriodIndicator-BbvhJIy8.js","assets/UIService-DF9B5YkQ.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-D08vCkb1.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

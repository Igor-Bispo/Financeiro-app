const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-C6mVWVKS.js","assets/main-CF1rWTKC.css","assets/CategoriesPage-6FDPBMCn.js","assets/PeriodIndicator-CK1vxorZ.js","assets/UIService-Bhth4ObY.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-C6mVWVKS.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-YYj9Rq1f.js","assets/main-5MXpa-vc.css","assets/CategoriesPage-DXlMOXIa.js","assets/PeriodIndicator-CCGIi_WI.js","assets/UIService-CH2wdutU.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-YYj9Rq1f.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

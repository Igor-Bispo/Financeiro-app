const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-D9o1gxcn.js","assets/main-CNDNG6O2.css","assets/CategoriesPage-D4vrVRO8.js","assets/PeriodIndicator-C1HO4Ge2.js","assets/UIService-B3MO-4M1.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-D9o1gxcn.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

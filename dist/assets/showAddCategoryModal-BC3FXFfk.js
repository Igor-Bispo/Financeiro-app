const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-C_-3nJ4i.js","assets/main-B6J4K76K.css","assets/CategoriesPage-5SOQskaS.js","assets/PeriodIndicator-BV9Ii4Rf.js","assets/UIService-k5SLdsuv.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-C_-3nJ4i.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

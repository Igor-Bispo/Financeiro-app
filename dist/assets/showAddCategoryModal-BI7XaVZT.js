const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CQcARcCF.js","assets/main-CHJigVyv.css","assets/CategoriesPage-DmVbDTaz.js","assets/PeriodIndicator-BpmGhe8r.js","assets/UIService-bgcF1pQM.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-CQcARcCF.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

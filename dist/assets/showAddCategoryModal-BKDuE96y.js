const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-B8ndfATB.js","assets/main-ByTmGh6x.css","assets/CategoriesPage-DwfpKyD3.js","assets/PeriodIndicator-BXT6K8aU.js","assets/UIService-C5QoG9bR.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-B8ndfATB.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

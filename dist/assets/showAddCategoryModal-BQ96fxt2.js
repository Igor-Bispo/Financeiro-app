const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BX9Jfuc6.js","assets/main-DSixVJDX.css","assets/CategoriesPage-DybXtoRp.js","assets/PeriodIndicator-DiwY5bjx.js","assets/UIService-BGa5m2pb.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BX9Jfuc6.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

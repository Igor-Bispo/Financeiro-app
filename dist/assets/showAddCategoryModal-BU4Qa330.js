const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-gto8VJpP.js","assets/main-COSfpVLA.css","assets/CategoriesPage-CchvEoOj.js","assets/PeriodIndicator-CkWI6aa9.js","assets/UIService-DtrNdnOp.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-gto8VJpP.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

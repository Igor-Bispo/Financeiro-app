const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-PXH-NkQu.js","assets/main-COkxcNvL.css","assets/CategoriesPage-C1P0nPK3.js","assets/PeriodIndicator-C_ycLqkN.js","assets/UIService-CybdG3Q8.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-PXH-NkQu.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

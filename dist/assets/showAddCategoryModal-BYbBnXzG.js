const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-OZuZ6ljI.js","assets/main-DLfePZs3.css","assets/CategoriesPage-CEB-p6Hd.js","assets/PeriodIndicator-DznB0GkL.js","assets/UIService-t_ksIaVI.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-OZuZ6ljI.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BURzCImH.js","assets/main-CXjbsgj6.css","assets/CategoriesPage-AlmQ75j0.js","assets/PeriodIndicator-DXSSQ0L4.js","assets/UIService-BIBn2LkR.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BURzCImH.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BJPbY-5a.js","assets/main-BAJxbLfa.css","assets/CategoriesPage-CrsjK3M5.js","assets/PeriodIndicator-CkYaGec5.js","assets/UIService-CKC_F923.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BJPbY-5a.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

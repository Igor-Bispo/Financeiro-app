const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DorGhGYu.js","assets/main-ChFBKGcA.css","assets/CategoriesPage-BylDjb0c.js","assets/PeriodIndicator-CWq_2Fku.js","assets/UIService-CAGt64he.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-DorGhGYu.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

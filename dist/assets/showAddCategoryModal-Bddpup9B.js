const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BvSQ2BG9.js","assets/main-CNDNG6O2.css","assets/CategoriesPage-w-iD5lzE.js","assets/PeriodIndicator-Deevupbs.js","assets/UIService-5TwKcwhx.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BvSQ2BG9.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

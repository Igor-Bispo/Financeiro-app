const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DP1a4-7N.js","assets/main-CcotyhXU.css","assets/CategoriesPage-BtqfJ-MA.js","assets/PeriodIndicator-DVA0Oq6y.js","assets/UIService-CHQ3o_Kn.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-DP1a4-7N.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

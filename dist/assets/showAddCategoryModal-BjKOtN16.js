const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BQzb2C9D.js","assets/main-B6J4K76K.css","assets/CategoriesPage-BnEI1pUO.js","assets/PeriodIndicator-0duRiC6e.js","assets/UIService-D9yi97jA.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BQzb2C9D.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CG45aA5x.js","assets/main-CNgGB7ml.css","assets/CategoriesPage-D9wJy_9p.js","assets/PeriodIndicator-ChwQCRMd.js","assets/UIService-e4a5cc_y.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-CG45aA5x.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

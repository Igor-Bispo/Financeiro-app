const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CYQf9UGs.js","assets/main-D0QIDqFn.css","assets/CategoriesPage-xvRnFRBA.js","assets/PeriodIndicator-D3NkTsZx.js","assets/UIService-DUODpXAz.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-CYQf9UGs.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DW9dpxe3.js","assets/main-CDeWMlCH.css","assets/CategoriesPage-CeqnBPno.js","assets/PeriodIndicator-D7uShpg1.js","assets/UIService-WLufdvoT.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-DW9dpxe3.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

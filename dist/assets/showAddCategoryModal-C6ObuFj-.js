const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-RAgMztXH.js","assets/main-CNDNG6O2.css","assets/CategoriesPage-BU9aQcm0.js","assets/PeriodIndicator-CWhSKmom.js","assets/UIService-DzCxoMei.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-RAgMztXH.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

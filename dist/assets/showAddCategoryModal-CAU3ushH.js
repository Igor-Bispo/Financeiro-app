const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-qpmFpkyH.js","assets/main-C07j7jEX.css","assets/CategoriesPage-CerEuWEI.js","assets/PeriodIndicator-DBNf484W.js","assets/UIService-CyIQDbv4.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-qpmFpkyH.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

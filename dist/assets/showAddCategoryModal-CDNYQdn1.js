const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DaYiHEuK.js","assets/main-CNDNG6O2.css","assets/CategoriesPage-BZ5V5MZn.js","assets/PeriodIndicator-DEZ2cOFy.js","assets/UIService-CXbUcYOs.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-DaYiHEuK.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

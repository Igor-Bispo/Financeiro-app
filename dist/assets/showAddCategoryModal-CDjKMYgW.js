const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BHEiUGry.js","assets/main-CcotyhXU.css","assets/CategoriesPage-X6BbMg4r.js","assets/PeriodIndicator-Bi7pF-bD.js","assets/UIService-BuKk5NNH.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BHEiUGry.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-IfYbxsCz.js","assets/main-DilUQiCL.css","assets/CategoriesPage-CI9B4QXj.js","assets/PeriodIndicator-DW2_keOF.js","assets/UIService-BBLNJzVM.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-IfYbxsCz.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-eHhcWHTe.js","assets/main-BT0j-YW6.css","assets/CategoriesPage-BCkq5W55.js","assets/PeriodIndicator-DJYSwsWm.js","assets/UIService-CPyk5hy3.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-eHhcWHTe.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

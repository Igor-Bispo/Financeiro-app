const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BBMSmpws.js","assets/main-CNDNG6O2.css","assets/CategoriesPage-DHut7Nin.js","assets/PeriodIndicator-y6Wxcpq4.js","assets/UIService-j7AVvRdD.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BBMSmpws.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

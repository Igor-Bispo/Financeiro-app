const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DP8XlPGe.js","assets/main-D61fcKV5.css","assets/CategoriesPage-Bd9QYIJe.js","assets/PeriodIndicator-D2nDRObn.js","assets/UIService-CzGWtSrl.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-DP8XlPGe.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

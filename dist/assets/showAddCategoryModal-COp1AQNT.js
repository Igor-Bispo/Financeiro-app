const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-PXBWkLUm.js","assets/main-COFdkNia.css","assets/CategoriesPage-kRvyHovY.js","assets/PeriodIndicator-C3_lZx8R.js","assets/UIService-VX_k4A0Q.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-PXBWkLUm.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

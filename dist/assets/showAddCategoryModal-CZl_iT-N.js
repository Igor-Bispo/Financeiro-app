const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DzokuhDG.js","assets/main-FkDBP48B.css","assets/CategoriesPage-3LPDrKP-.js","assets/PeriodIndicator-DlteA2Hu.js","assets/UIService-Cd25vO3C.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-DzokuhDG.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

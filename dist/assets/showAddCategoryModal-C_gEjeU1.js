const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BgdTAIhM.js","assets/main-CcotyhXU.css","assets/CategoriesPage-DY3El1NU.js","assets/PeriodIndicator-se6r7eHK.js","assets/UIService-AcYpZD3K.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BgdTAIhM.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BxMd2v3z.js","assets/main-Nl9vEH5P.css","assets/CategoriesPage-BTc8Db2V.js","assets/PeriodIndicator-BR2IIG30.js","assets/UIService-CzOhiUeB.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-BxMd2v3z.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

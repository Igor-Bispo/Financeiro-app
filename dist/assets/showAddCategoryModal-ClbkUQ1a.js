const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CUkmK97J.js","assets/main-C07j7jEX.css","assets/CategoriesPage-CyJ252q1.js","assets/PeriodIndicator-BCfoXbxD.js","assets/UIService-CcTfWNi2.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-CUkmK97J.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

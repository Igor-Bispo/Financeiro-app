const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-rsqzOoFk.js","assets/main-Fqk61SfB.css","assets/CategoriesPage-D1gQK8c1.js","assets/PeriodIndicator-BE01faNm.js","assets/UIService-vqVTJ1q0.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-rsqzOoFk.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-mYGWX_iE.js","assets/main-CXjbsgj6.css","assets/CategoriesPage-Cthx2y8L.js","assets/PeriodIndicator-g_YND6zk.js","assets/UIService-Ds_78etb.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-mYGWX_iE.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

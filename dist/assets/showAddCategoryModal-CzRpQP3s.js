const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-j3nK2J4O.js","assets/main-BleMDWW2.css","assets/CategoriesPage-Drbb9fNf.js","assets/PeriodIndicator-CF7fmBJH.js","assets/UIService-BeC542oU.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-j3nK2J4O.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

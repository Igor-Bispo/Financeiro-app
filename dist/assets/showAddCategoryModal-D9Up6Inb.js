const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-Bd5V083V.js","assets/main-BArdUXWZ.css","assets/CategoriesPage-BLu1S3qY.js","assets/PeriodIndicator-TFkZO3uB.js","assets/UIService-DrHJxOyb.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-Bd5V083V.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BPYh3IOP.js","assets/main-B6J4K76K.css","assets/CategoriesPage-0EmVsc3S.js","assets/PeriodIndicator-CCPXzyv8.js","assets/UIService-BfPkDpNO.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BPYh3IOP.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

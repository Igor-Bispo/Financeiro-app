const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-LZihGkTp.js","assets/main-Bre1GEDK.css","assets/CategoriesPage-Dn7ub2H1.js","assets/PeriodIndicator-CMrRJOHM.js","assets/UIService-CZO5dWqv.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-LZihGkTp.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

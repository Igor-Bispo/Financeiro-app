const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BcUJFR68.js","assets/main-CXjbsgj6.css","assets/CategoriesPage-8UYoI1x4.js","assets/PeriodIndicator-5GNPehTh.js","assets/UIService-wtgZbXv-.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BcUJFR68.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

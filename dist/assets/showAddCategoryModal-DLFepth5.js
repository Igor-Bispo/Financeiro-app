const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-7D4OXVv2.js","assets/main-CNDNG6O2.css","assets/CategoriesPage-m2hBAzxW.js","assets/PeriodIndicator-CRpMgQ8m.js","assets/UIService-f6Wqt8H9.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-7D4OXVv2.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-Dih7wz5u.js","assets/main-CLUoy63M.css","assets/CategoriesPage-5CNDJRIy.js","assets/PeriodIndicator-B-bFd6ZX.js","assets/UIService-DF-KqicZ.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-Dih7wz5u.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

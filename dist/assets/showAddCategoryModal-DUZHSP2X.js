const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-Zy6HtbI1.js","assets/main-CKyDbaJt.css","assets/CategoriesPage-0N3NHGmn.js","assets/PeriodIndicator-CqO9N9Dh.js","assets/UIService-W35vHiy_.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-Zy6HtbI1.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

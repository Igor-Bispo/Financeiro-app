const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BXYtYEOT.js","assets/main-D0hxuXxz.css","assets/CategoriesPage-43ZVm8zS.js","assets/PeriodIndicator-C6vg1QlT.js","assets/UIService-C3SX8riP.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BXYtYEOT.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

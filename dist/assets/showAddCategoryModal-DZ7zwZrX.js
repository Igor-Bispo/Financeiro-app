const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-tWUdnkzv.js","assets/main-Drn95-wI.css","assets/CategoriesPage-P20JeNUP.js","assets/PeriodIndicator-6cPn_XN0.js","assets/UIService-eA050Z34.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-tWUdnkzv.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

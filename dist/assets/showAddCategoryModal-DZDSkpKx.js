const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DQ8FQ5hN.js","assets/main-ByTmGh6x.css","assets/CategoriesPage-CLPwR88t.js","assets/PeriodIndicator-CPh3ZCgH.js","assets/UIService-B9hQKKlN.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-DQ8FQ5hN.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BXUJHJVH.js","assets/main-6ahFnZtK.css","assets/CategoriesPage-CdciA40Q.js","assets/PeriodIndicator-D1Kyl8cl.js","assets/UIService-BxMF174i.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-BXUJHJVH.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-PhcSwhut.js","assets/main-CDeWMlCH.css","assets/CategoriesPage-zeqDvONO.js","assets/PeriodIndicator-Cm1UaqNO.js","assets/UIService-ChZy7Fr2.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-PhcSwhut.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

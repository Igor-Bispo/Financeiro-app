const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main--Xl17bQY.js","assets/main-CDeWMlCH.css","assets/CategoriesPage-10yRyAmn.js","assets/PeriodIndicator-BqYBhOIH.js","assets/UIService-CAdhZLUq.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main--Xl17bQY.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-B3AL1zD1.js","assets/main-CNDNG6O2.css","assets/CategoriesPage-BwbLLX1N.js","assets/PeriodIndicator-Vho4vw9H.js","assets/UIService-Bk7hIFJQ.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-B3AL1zD1.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

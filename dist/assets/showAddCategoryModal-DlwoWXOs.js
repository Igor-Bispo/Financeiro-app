const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CnJ8cnF7.js","assets/main-Dzu0XLDS.css","assets/CategoriesPage-CuUgigDd.js","assets/PeriodIndicator-BuYZ9jOb.js","assets/UIService-CIYkElcj.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-CnJ8cnF7.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

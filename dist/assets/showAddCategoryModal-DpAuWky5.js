const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DsAuhAan.js","assets/main-CFaln2f9.css","assets/CategoriesPage-wDn6HQ6p.js","assets/PeriodIndicator-lRCI5Da5.js","assets/UIService-BIxO5kA6.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-DsAuhAan.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

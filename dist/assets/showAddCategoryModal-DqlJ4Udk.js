const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BuU9YFt4.js","assets/main-Nl9vEH5P.css","assets/CategoriesPage-FN-up2d6.js","assets/PeriodIndicator-BWCEMKLy.js","assets/UIService-C-G1Scml.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-BuU9YFt4.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-ptrgHp1i.js","assets/main-B6J4K76K.css","assets/CategoriesPage-CxJDJ0tC.js","assets/PeriodIndicator-DmNBu2z4.js","assets/UIService-H_B-t286.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-ptrgHp1i.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

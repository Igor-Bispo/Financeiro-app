const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CcZKm8fI.js","assets/main-BElJ5o_f.css","assets/CategoriesPage-DAoq-ymm.js","assets/PeriodIndicator-gJ2Dq4SH.js","assets/UIService-CYnujjG2.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-CcZKm8fI.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-_5ZOImbO.js","assets/main-B6J4K76K.css","assets/CategoriesPage-DCi_uXv9.js","assets/PeriodIndicator-BAaeT9bL.js","assets/UIService-D0sfO7UZ.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-_5ZOImbO.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

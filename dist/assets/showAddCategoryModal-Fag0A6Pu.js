const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DKF2ZBDz.js","assets/main-DoMnXQ33.css","assets/CategoriesPage-DAaByhzr.js","assets/PeriodIndicator-z2awRg9P.js","assets/UIService-D8nXzuWs.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-DKF2ZBDz.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-D2wVPua5.js","assets/main-DXyD7XR6.css","assets/CategoriesPage-DGEsFQej.js","assets/PeriodIndicator-D3ntqU6d.js","assets/UIService-BK5hqIHA.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-D2wVPua5.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

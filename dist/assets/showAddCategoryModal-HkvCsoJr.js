const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-Cs904V1_.js","assets/main-2m3q-emk.css","assets/CategoriesPage-YlUsoTti.js","assets/PeriodIndicator-BSUFCTLy.js","assets/UIService-DfW1RsG0.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-Cs904V1_.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-LdV9j_Y2.js","assets/main-CxGfDWYU.css","assets/CategoriesPage-CLpstUHS.js","assets/PeriodIndicator-sUTJmC9Z.js","assets/UIService-C1fQMUZE.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-LdV9j_Y2.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CKc-yMBt.js","assets/main-DtfDRgsQ.css","assets/CategoriesPage-CJaXUcRJ.js","assets/PeriodIndicator-DhlbaBSk.js","assets/UIService-D7ePg25V.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-CKc-yMBt.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-e7CVpR5b.js","assets/main-CTiT3DDb.css","assets/CategoriesPage-EwmRf37K.js","assets/PeriodIndicator-D2aU8BwM.js","assets/UIService-CR8jDJ8_.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-e7CVpR5b.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

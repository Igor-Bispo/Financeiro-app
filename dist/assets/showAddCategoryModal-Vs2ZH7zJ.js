const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-Z-WQKkUj.js","assets/main-COFdkNia.css","assets/CategoriesPage-Dky-X5UP.js","assets/PeriodIndicator-DLu_Pz76.js","assets/UIService-CeIR-r4I.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-Z-WQKkUj.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-C8a4vpso.js","assets/main-BOsFcM3L.css","assets/CategoriesPage-C5wEaFMc.js","assets/PeriodIndicator-DxUBqyT0.js","assets/UIService-CfQnDPBF.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-C8a4vpso.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

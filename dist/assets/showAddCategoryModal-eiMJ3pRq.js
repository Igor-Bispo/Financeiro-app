const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-1DkdKBRl.js","assets/main-CsmOb3cC.css","assets/CategoriesPage-vvBLfvvI.js","assets/PeriodIndicator-BK38mPnV.js","assets/UIService-7h3Jy7wK.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-1DkdKBRl.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

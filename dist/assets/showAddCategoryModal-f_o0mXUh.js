const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-Su3YR3-B.js","assets/main-CDeWMlCH.css","assets/CategoriesPage-D-ofmNqd.js","assets/PeriodIndicator-DgnjmCPJ.js","assets/UIService-BoK3eeD4.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-Su3YR3-B.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

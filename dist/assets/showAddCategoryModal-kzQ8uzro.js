const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-B-XVfQ8M.js","assets/main-Cn8BSRqe.css","assets/CategoriesPage-qPYCdC2c.js","assets/PeriodIndicator-a2W_bjaH.js","assets/UIService-CkqgNauy.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-B-XVfQ8M.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

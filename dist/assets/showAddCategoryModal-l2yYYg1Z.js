const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-kf7gv-aY.js","assets/main-CXjbsgj6.css","assets/CategoriesPage-CrYUw8Df.js","assets/PeriodIndicator-DUMQe4l_.js","assets/UIService-CWt7M93N.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-kf7gv-aY.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-Jm9lcso0.js","assets/main-CXjbsgj6.css","assets/CategoriesPage-D_KztAc7.js","assets/PeriodIndicator-D75S6c3O.js","assets/UIService-BsauGDMF.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-Jm9lcso0.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

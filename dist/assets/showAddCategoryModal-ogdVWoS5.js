const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CwyRbrt1.js","assets/main-Bjqwg0h6.css","assets/CategoriesPage-BToy4Mer.js","assets/PeriodIndicator-DVPQSjAd.js","assets/UIService-gNanDB6v.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-CwyRbrt1.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

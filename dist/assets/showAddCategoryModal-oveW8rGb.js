const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DmpReI0_.js","assets/main-CcotyhXU.css","assets/CategoriesPage-BsKI516C.js","assets/PeriodIndicator-B92ED4FA.js","assets/UIService-Ci3y_Kq2.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-DmpReI0_.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

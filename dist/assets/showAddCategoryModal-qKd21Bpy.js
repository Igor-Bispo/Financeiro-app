const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DHJVLCcE.js","assets/main-BOsFcM3L.css","assets/CategoriesPage-l_x-DKym.js","assets/PeriodIndicator-Wbz26TDG.js","assets/UIService-BPeE_Ab9.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-DHJVLCcE.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

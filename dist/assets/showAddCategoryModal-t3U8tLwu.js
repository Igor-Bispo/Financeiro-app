const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CbS2epR0.js","assets/main-B6J4K76K.css","assets/CategoriesPage-xA5tpekv.js","assets/PeriodIndicator-B5XXzX3k.js","assets/UIService-bUKfUxTz.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-CbS2epR0.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

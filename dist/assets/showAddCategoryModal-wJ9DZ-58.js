const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DhL3ti3v.js","assets/main-CF1rWTKC.css","assets/CategoriesPage-U6kun8hV.js","assets/PeriodIndicator-BG3gLPT5.js","assets/UIService-4JTkT8jT.js"])))=>i.map(i=>d[i]);
import{M as m,_ as d,S as s}from"./main-DhL3ti3v.js";function u(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BP239M0a.js","assets/main-BBiyeTyG.css","assets/CategoriesPage-OlJPVcQo.js","assets/PeriodIndicator-DB6ngLoe.js","assets/UIService-DMQqowy6.js"])))=>i.map(i=>d[i]);
import{M as m,_ as l,S as s}from"./main-BP239M0a.js";window.showAddCategoryModal=function(e={}){console.log("🔧 showAddCategoryModal chamada com:",e),console.log("🔧 window.Modal disponível:",!!window.Modal);const t=!!e&&Object.keys(e).length>0;try{const o=m({title:t?"Editar Categoria":"Nova Categoria",content:`

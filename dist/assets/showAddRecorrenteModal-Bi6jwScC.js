const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DC5CTMgn.js","assets/main-Bre1GEDK.css","assets/NotificationService-DOyI8-Bp.js"])))=>i.map(i=>d[i]);
import{M as V,S as E,y as M,z as L,_ as g,c as T,g as D,q,w as A,o as S}from"./main-DC5CTMgn.js";function k({onSubmit:v,initialData:c={}}){const s=document.createElement("form");s.className="space-y-4",s.innerHTML=`
   ...
   <option value="" style="font-weight: 500; padding: 12px; font-size: 14px;">Selecione uma categoria...</option>
        ${(window.appState.categories||[]).sort((o,l)=>o.nome.localeCompare(l.nome,"pt-BR",{sensitivity:"base"})).map(o=>{const l=new Date,r=l.getFullYear(),a=l.getMonth()+1,t=(window.appState.transactions||[]).filter(f=>{if(f.categoriaId!==o.id||f.tipo!==o.tipo)return!1;let y;f.createdAt&&typeof f.createdAt=="object"&&f.createdAt.seconds?y=new Date(f.createdAt.seconds*1e3):y=new Date(f.createdAt);const I=y.getFullYear(),p=y.getMonth()+1;return I===r&&p===a}).reduce((f,y)=>f+parseFloat(y.valor),0),n=parseFloat(o.limite||0),d=o.tipo==="receita"?t:n-t;let m=o.nome;return n>0&&(m+=` - Limite: R$ ${n.toFixed(2)}`,o.tipo==="despesa"?m+=` (Disponível: R$ ${Math.max(0,d).toFixed(2)})`:m+=` (Recebido: R$ ${t.toFixed(2)})`),`<option value="${o.id}" ${c.categoriaId===o.id?"selected":""} style="font-weight: 500; padding: 8px;">${m}</option>`}).join("")}
      </select>
    </div>
    <div>

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BOoQpQLk.js","assets/main-B6J4K76K.css","assets/NotificationService-C2-OZw3E.js"])))=>i.map(i=>d[i]);
import{M as V,S as E,y as M,z as L,_ as g,c as T,g as D,q,w as A,o as S}from"./main-BOoQpQLk.js";function k({onSubmit:v,initialData:c={}}){const s=document.createElement("form");s.className="space-y-4",s.innerHTML=`

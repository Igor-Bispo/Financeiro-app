const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-BcUJFR68.js","assets/main-CXjbsgj6.css","assets/NotificationService-ApYam5y5.js"])))=>i.map(i=>d[i]);
import{M as V,S as E,y as M,z as L,_ as g,c as T,g as D,q,w as A,o as S}from"./main-BcUJFR68.js";function k({onSubmit:v,initialData:c={}}){const s=document.createElement("form");s.className="space-y-4",s.innerHTML=`

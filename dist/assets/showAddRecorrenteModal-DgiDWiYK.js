const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DP1a4-7N.js","assets/main-CcotyhXU.css","assets/NotificationService-MlHMYKtn.js"])))=>i.map(i=>d[i]);
import{M as V,S as E,y as M,z as L,_ as g,c as T,g as D,q,w as A,o as S}from"./main-DP1a4-7N.js";function k({onSubmit:v,initialData:c={}}){const s=document.createElement("form");s.className="space-y-4",s.innerHTML=`

...
// Expor uma funÃ§Ã£o global apenas para testes manuais sem alterar o fluxo legado
...
if (typeof window !== 'undefined') {
  ...
  // NÃ£o hÃ¡ teardown do legado aqui; um reload garante estado
  console.info('Router desabilitado (removido de localStorage). Recarregue se necessÃ¡rio.');
    } catch (err) {
...
// MantÃ©m desligado por padrÃ£o (APP_CONFIG.ui.useRouter === false)
function wantRouter() {
  try {
...
async function startRouter() {
  if (typeof window !== 'undefined' && window.__routerBootstrapped) {
    return; // evitar bootstraps mÃºltiplos
  }
  try {

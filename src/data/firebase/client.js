...
// InicializaÃ§Ã£o central do Firebase (env ou fallback)
...
// Config via env; se nÃ£o houver, usar os valores atuais do projeto para compatibilidade
...
let analytics = null;
try { analytics = getAnalytics(app); } catch { /* analytics pode nÃ£o estar disponÃ­vel */ }

// Garanta que a persistÃªncia esteja configurada antes de qualquer listener de auth

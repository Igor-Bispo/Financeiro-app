...
// RepositÃ³rio de orÃ§amentos: esconde Firebase atrÃ¡s de um contrato estÃ¡vel.
...
export function listenToChanges(userId, callback) {
  ...
  // Sem orderBy; ordenar no cliente para evitar Ã­ndices
...
// Adiciona um usuÃ¡rio ao orÃ§amento (array usuariosPermitidos)

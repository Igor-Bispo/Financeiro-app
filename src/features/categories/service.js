...
// Carregar categorias do or̤amento
export async function loadCategories(budgetId) {
  try {
    ...
    // Fallback legado: algumas categorias antigas podem ṇo ter budgetId
    try {
...
export async function createCategory(data) {
  try {
    ...
    // Atualiza̤̣o otimista do store e estado global
    try {
    ...
    // Enviar notifica̤̣o de categoria criada (or̤amento compartilhado)
    try {
    ...
    } catch (e) { console.warn('Falha ao notificar cria̤̣o de categoria:', e); }
...
export async function updateCategory(id, data) {
  try {
    // Obter snapshot anterior para compor changeSet na notifica̤̣o
    let prev = null;
    ...
    // Enviar notifica̤̣o de atualiza̤̣o de categoria com changeSet
    try {
    ...
    } catch (e) { console.warn('Falha ao notificar atualiza̤̣o de categoria:', e); }
  } catch (error) {
    eventBus.emit('error:category', error);
    throw error;
  }
...
export async function deleteCategory(id) {
  try {
    ...
    } catch (e) { console.warn('Falha ao notificar excluṣo de categoria:', e); }
  } catch (error) {
    eventBus.emit('error:category', error);
    throw error;
  }

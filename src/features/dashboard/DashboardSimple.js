...
export function renderDashboard(container) {
  ...
  html += '    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-4 shadow-lg border border-gray-200 dark:border-gray-600">';
  html += '      <div class="flex items-center justify-between w-full">';
  html += '        <!-- Título com ícone e badge -->';
  html += '        <div class="flex items-center gap-3">';
  html += '          <div class="flex items-center gap-2">';
  html += '            <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-md">';
  html += '              <span class="text-white text-lg">📊</span>';
  html += '            </div>';
  html += '            <div>';
  html += '              <h2 class="text-gray-800 dark:text-white font-bold text-lg">Dashboard</h2>';
  html += '              <div class="flex items-center gap-1">';
  html += '                <span class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>';
  html += '                <span class="text-green-600 dark:text-green-400 text-xs font-medium">Tempo Real</span>';
  html += '              </div>';
  html += '            </div>';
  html += '          </div>';
  html += '        </div>';
  html += '        <!-- Seletor de período integrado -->';
  html += '        <div class="bg-white dark:bg-gray-800 rounded-xl px-4 py-2 shadow-sm border border-gray-200 dark:border-gray-600">';

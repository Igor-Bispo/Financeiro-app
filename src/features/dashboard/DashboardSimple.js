...
export function renderDashboard(container) {
  ...
  html += '        <div class="hidden md:flex items-center gap-1 text-xs bg-green-100 dark:bg-green-900/30 px-2 py-1 rounded-md">';
  html += '          <span class="w-2 h-2 bg-green-500 rounded-full"></span>';
  html += '          <span class="text-green-700 dark:text-green-300">Tempo Real</span>';
  html += '        </div>';
  html += '      </div>';
  html += '      <div class="flex items-center gap-2">';

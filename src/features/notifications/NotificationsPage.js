...
export async function renderNotifications() {
    ...
    : `
        ...
        <div class="u-card bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden p-4">
                <div class="empty-state">
                  ...
                  <div class="empty-description">Você não tem notificações no momento</div>
                  <p class="text-xs opacity-90">Período: <span class="font-semibold">${monthName} / ${selYear}</span></p>
  ...
  const archivedSectionHtml = archived.length ? renderSection('📦 Arquivadas', groupedArchived) : '';
        ...
        <div class="content-spacing">
          ...
          <div class="mb-8">
            <div class="flex items-center gap-2 mb-4">
              ...
              <h2 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100">⚙️ Ações & Controles</h2>
            </div>
  ...
  <button onclick="window.resetNotificationFilters && window.resetNotificationFilters()" class="ml-2 u-btn u-btn--ghost text-xs">↺ Redefinir filtros</button>
                  </div>
...
async function loadNotifications() {
  ...
  console.warn('Falha ao buscar lista inicial de notificações:', e);
      }

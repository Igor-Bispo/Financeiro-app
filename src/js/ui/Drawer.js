export function renderDrawer() {
  ...
  drawer.className = 'fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-900 shadow-lg z-50 transform -translate-x-full transition-transform duration-300 border-r border-gray-300 dark:border-gray-700';
